...
<form name="contactcas" id="contactcas" class="contactusfrm" method="post" action="common/process/contactcas-form-process-user.php">

<fieldset><legend style="">Send us a Message or Ask a Question</legend><br><br>
...
</td></tr><tr><td><label>Phone: </label></td><td><input type="text" id="umobile" name="umobile" style="border:1px solid #660000;" value="<?php echo $umobile; ?>" required> 
