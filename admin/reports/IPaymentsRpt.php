...
if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="" || $aperms < $pageperms){header('Location: ../worldview/index.php?msg=You_do_not_have_permission_to_view_that_page');}else{
 ...
 $query = "SELECT * FROM i_payments ORDER BY ip_date desc";  
 $result = mysqli_query($connect, $query);  
 ?>  
 <!DOCTYPE html>  
 <html>  
      <head>  
           <title>IPayments</title>  
      ...
      <body>  
           ...
           <div class="container" style="width:900px;">  
                <h2 align="center"></h2>  
                <h3 align="center">Payment Report Start</h3><br />  
                <div class="col-md-3">  
                ...
                <div id="return_results">  
                     <table class="table table-bordered">  
                          <tr> 
                               <th width="5%">CheckNum</th>  
                     <th width="20%">Invoice Id</th>  
                     <th width="23%">Recd By</th>  
                      <th width="23%">Type</th> 
                     ...
                     ?>  
                          <tr>  
                               <td><?php echo $row["ip_checknum"]; ?></td>  
                               <td><?php echo $row["ip_iid"]; ?></td>  
                               <td><?php echo $row["ip_recvdby"]; ?></td>  
                               <td><?php echo $row["ip_type"]; ?></td>  
                               <td>$ <?php echo $row["ip_amount"]; ?></td>  
                               <td><?php echo $row["ip_date"]; ?></td>  
                          </tr>  
                          <?php  
                         $itot = $itot + $row["ip_amount"];
                   }  
