...
<body>
    <table id = "Main" style = "width:750px;border:none;margin:1px;padding:1px;">
<tr>
                    <th width="150px" style = "text-align:left;">Month</th>  
                     <th width="150px" style = "text-align:left;">Invoiced</th>  
					 <th width="150px" style = "text-align:left;">Registered</th>  
                     <th width="150px" style = "text-align:left;">Sold</th>  
					 <th width="150px" style = "text-align:left;">Receipts</th> 
...
?>
<tr>
    <td colspan ='1' align='left'><?php echo date('F', strtotime("2012-$prevMonth"));?>
    <?php echo $year;?></td>
    <td align='right'><?php echo money_format('%.2n', $totalAmt); ?></td>
...
if($totalAmt != 0){
                  ...
                  ?>
<tr>
    <td colspan ='1' align='left'><?php echo date('F', strtotime("2012-$month-01"));?><?php echo ' '.$year;?></td>
    <td align='right'><?php echo money_format('%.2n', $totalAmt); ?></td>
