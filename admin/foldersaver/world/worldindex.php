...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
		...
		<link rel="stylesheet" href="/common/css/adminWorld.css" type="text/css" />
...
<div id="rightcolumnAdminIncludeClip">
	...
	if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	{
	 ...
	 <?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	{}else{ include '../../caslog/includes/navcontents-admin.html';
include '../../caslog/includes/admin-navcontents-noboot.html';
  }?>
...
<script src="/common/js/nobootstrap-nav.js"></script>
<script>
