...
<div id="popup1" class="modal-box">
 ...
 <input class="nbi" type="text" name="uname" id="uname" value=""></br></br>
...
<div id="popup2" class="modal-box">
  ...
  <div class="modal-body">
    <label>dID</label>
  <label>did</label><input class="nbi" type="text" name="did" id="did" value=""></br>
  <label>dname</label><input class="nbi" type="text" name="dname" id="dname" value=""></br>
  <label>sdcontact</label><input class="nbi" type="text" name="sdcontact" id="sdcontact" value=""></br>
  <label>dphone</label><input class="nbi" type="text" name="dphone" id="dphone" value=""></br>
  </div>
  <footer> <a href="#" class="btn btn-small js-modal-close">Close</a> </footer>
</div>
...
$(".d_announce").click(function(){ // Click to only happen on d_announce links
     ...
     $("#sdcontact").val($(this).data('sdcontact'));
     $("#dphone").val($(this).data('dphone'));
     $('#').modal('show');
   });
