...
<link rel="stylesheet" type="text/css" href="css/casworldview.css">
<link rel="stylesheet" type="text/css" href="css/casworldview-login.css">
...
<div class="wbannerline">
	...
	<?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	{}else{ include 'views/reconhtml.html';
