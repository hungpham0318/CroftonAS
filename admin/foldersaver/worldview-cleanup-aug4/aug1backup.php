...
<div class="container tablewrapper" style="display:block;">
	...
	{
		echo'<div id="wbannerline"><div class="wbannerline"><img class="worldbannerline" src="/images/croftonasbanner3.png"  alt="crofton auction services banner for website" /><div class="wbannerline" style="float:right;" width:18%">';
			//include 'forms/li-form-admin.html';
include 'adminloginnew.html';
			include "admin/process/casadmin-login.php";
		//echo'<div id="wbannerline"><div class="worldbannerline"><img class="worldbannerline" src="/images/croftonasbanner3.png"  alt="crofton auction services banner for website" />';
		//echo"</div></div></div><!--NOT logged in and close div after login form displayed-->";
	}else{ 
		include 'css/snow-admin-nav.html';
		echo'<br/><div id="worldbannerline" >';
		include 'css/status-key.html';
		include 'css/substatus-key.html';
		include 'css/substatus-key.html';
		echo'<br/></div><!--Close id-worldbannerline div-->';
	}?>
	...
	{echo '<p>Log in to see contents</p><!--sect1leftcolcomingfromifNOTloggedin=cannot go past-->';
	}else{ 
	include 'views/reconhtml.html';
	echo "</script></div><!-- close section1  -->";
	}?> 
