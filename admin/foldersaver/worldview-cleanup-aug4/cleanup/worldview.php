<?php session_start();
//admin/worldview/worldview.php
$title="World View Home";
...
<link rel="stylesheet" href="../Editor/css/editor.dataTables.min.css">		<link rel="stylesheet" href="css/world-admin.css" type="text/css">
...
<div ><!-- un-id-d navigation div -->
	...
	{}else{ include '../../common/css/birdmenu/snow-admin-nav.html';
	}?>
	<br/>
