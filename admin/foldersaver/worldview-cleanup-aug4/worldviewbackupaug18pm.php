...
<div class="container tablewrapper" style="display:block;">
	...
	{
		echo'<div id="wbannerline"><img class="worldbannerline" src="/images/croftonasbanner3.png"  alt="crofton auction services banner for website" />
<div class="">';
			
include 'adminloginnew.html';
echo"</div>";
			
	}else{ echo'<div id="wbannerline" style="display:block;">';
...
echo'</div>';
		echo'</div><!--Close id-worldbannerline div-->';
	}?>
