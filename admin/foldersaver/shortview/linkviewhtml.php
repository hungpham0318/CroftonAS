<?php session_start();
//admin/mainview/shortviewhtml.php
...
<title>linkview_reorder columns and column visibility with joins</title>
<!-- below added for viewinfomodal -->
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>  <script src="http://code.jquery.com/ui/1.11.1/jquery-ui.min.js"></script>
 <!-- above added for dialog -->
<script src="http://code.jquery.com/jquery-1.12.0.min.js"></script>
