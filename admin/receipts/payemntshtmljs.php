...
<body><div class="container" style="width:80%;margin:0 auto;">
...
<div id="myModal" class="envelope" style="display:block;">
  ...
  <!--   <span class="close" id="span">&times;</span>
    ...
    <table style="width:100%;"><thead><th style="width:100%;margin:5px;">Charges for Invoice# <?php echo $qiid;?></th><th style="width:1%;margin:1px;" ></th></thead><tr><td><div id="udr" style="border:none;width:100%;display:inline-block;"><div style="width:100%;margin:5px;text-align:center">If you are entering a new payment, Click New Payment to create the payment then choose the new payment row to apply the payment to the invoice items, to see all the items for this invoice again, click any payment and the item table will be shown.  (This procedure is a little awkward, but records the payments appropriately. So, while I am not completely happy with this, it works for now.) <iframe sandbox="allow-same-origin allow-modals allow-scripts" src="/admin/receipts/invoicepaymentshtmljs.php?iid=<?php echo $qiid;?>" style="width:100%;height:500px;border:none;" ></iframe></div></div>
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: "paymentonlyphp.php?iid=<?php echo $qiid;?>",
display: 'envelope',
//display: 'lightbox',
       table: "#example",
       template: '#customForm',
