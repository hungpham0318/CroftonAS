...
<div style="width:97%;margin: 0 auto; ">Obviously, the address and city fields are only as good as the data in the dealers table.
<table id="example" class="display compact" cellspacing="0" width="100%" style = "font-size: 12px!important;">


<thead><tr style ="padding-left:4px; padding-right:2px;"><th style ="width: 7em;">Dealership</th><th>DID</th><th>Oldest</th><th>Newest</th><th># of Unpaid Inv </th><th>Outstanding Amount</th><th>Address</th><th>City</th><th>Contact</th><th>Contact Phone</th></tr></thead>
...
echo'<td>'.$row['idname'].'</td><td>'.$drow['did'].'</td><td>'.$row['idate'].'</td><td>'.$ddnewest.'</td><td>'.$row['iid'].'</td><td>'.$row['itotal'].'</td><td>'.$daaddress.'</td><td>'.$dacity.'</td><td>'.$dasdcontact.'</td><td>'.$dasdphone.'</td></tr>';}
}
...
<tfoot><tr><th>Dealership</th><th>DID</th><th>Oldest</th><th>Newest</th><th># Unpaid Inv </th><th>Outstanding Amount</th><th>Address</th><th>City</th><th>Contact</th><th>Contact Phone</th></tr></tfoot></table></div>
<script>
