...
<thead><tr style ="padding-left:4px; padding-right:2px;"><th style ="width: 7em;">Dealership</th><th>DID</th><th>Oldest</th><th>Newest</th><th># of Unpaid Inv </th><th>Outstanding Amount</th><th>Address</th><th>City</th></tr></thead>
...
echo'<td>'.$row['idname'].'</td><td>'.$drow['did'].'</td><td>'.$row['idate'].'</td><td>'.$ddnewest.'</td><td>'.$row['iid'].'</td><td>'.$row['itotal'].'</td><td>'.$daddress.'</td><td>'.$dcity.'</td></tr>';}
}
...
<tfoot><tr><th>Dealership</th><th>DID</th><th>Oldest</th><th>Newest</th><th># of Unpaid Inv </th><th>Outstanding Amount</th><th>Address</th><th>City</th></tr></tfoot></table></div>
<script>
