...
{"label": "Pmt. Type","name":"i_payments.ip_type", def:"Check", type: "select",
options: [{
    label: 'Check',
    value: 'Check'
  }, {
...
//{"label": "Invoice Total","name":"invoices.itotal" def: "invoices.itotal"}
...
//   var stillDue = divTotal - pageTotal;
 ...
 // if (pageTotal > 0){stillDue='$'.stillDue;}
  $(api.column(4).header()).html('$' + (pageTotal).formatMoney(2, '.', ',')   + '<br/>Total Payments');
