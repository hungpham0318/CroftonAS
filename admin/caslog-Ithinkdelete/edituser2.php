...
</td></tr><tr><td> <input type="hidden" class="info" name="uid" maxlength="100"value="<?php echo $uid;?>" required readonly></td>
...
<tr>
	<td class="label">&nbsp;&nbsp;&nbsp;Notes:</td>
               ...
               <tr>
                  ...
                  <td><input type="submit" class="pure-button button-success" style="width: 200px;" name="submit" value="Update User">
                        </td>
                </tr>
            </table>
        </td>
