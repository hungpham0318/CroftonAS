...
echo '<table id="testTable" class="display"></br></br><thead><th>User ID</th><th>Users Full Name</th><th>Phone</th><th>Username</th><th>Email</th><th>.......</th><th>Edit</th><th></th></tr></thead></br></br><tfoot><th>User ID</th><th>Users Full Name</th><th>Phone</th><th>Username</th><th>Email</th><th>.......</th><th>Edit</th><th></th></tr></tfoot><tbody class="display_table"><tr>';
...
//$decrypted = rtrim(mcrypt_decrypt(MCRYPT_RIJNDAEL_256, md5($key), base64_decode($encrypted), MCRYPT_MODE_CBC, md5(md5($key))), "\0");
    ...
    echo '<td>'.$row['uid'].'</td>'.'<td>'.$row['uname'].'</td>'.'<td>'.$row['umobile'].'</td>'.'<td>'.$row['username'].'</td>'.'<td>'.$row['email'].'</td>'.'<td><span style="font-size:1em;color:#ffffff;">'.$row['password'].'</span></td>';
