...
$url = preg_replace('/\?.*/', '',  $_SESSION['url']); //To remove query string
//$_SESSION['url'] = preg_replace('/\?.*/', '',  $_SERVER['HTTP_REFERER']); //To remove query string
...
$_SESSION['uid']=$result['uid'];
	...
	else{header("Location: ".$url."?res=3");
	}
	}
	exit;?>