...
<?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	...
	//begin insert
echo'
<form action="userdrelatetoedit.php" method="post">
<div id="headline">Choose User to See Dealership Relatives</br></div>
 ...
 while($row = mysql_fetch_array($result))
    ...
    echo "</select>";
       ...
       echo' </td>
                    ...
                    <td class="label">&nbsp;</td>
                        <td>
                            <span style="font-size:12px;"><input class="pure-button button-success" style="font-size:12px;" type="submit" name="submit" value="View Dealerships"></p>
                        </td>
                </tr>
            </table>
        </td>
