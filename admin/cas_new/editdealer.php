        ...
        <td width="400">
            ...
            <tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td class="dlabel">Mail Account:</td>
                    <td><input type="text" class="dinfo" Title="MailAccount" name="dmailAcctNum" value="<?php echo $dmailAcctNum;?>" ></td>
                </tr>
                 <tr>
                    <td class="dlabel">Notes:</td>
                    <td><input type="text" class="dinfo" Title="Notes" name="dnotes" value="<?php echo $dnotes;?>" ></td>
                </tr>
