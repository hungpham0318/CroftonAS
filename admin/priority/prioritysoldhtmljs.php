...
<editor-field name="priority_mvehicles.mstock"></editor-field>
...
<editor-field name="priority_mvehicles.msolddate"></editor-field>
<editor-field name="priority_mvehicles.msoldprice"></editor-field>
<editor-field name="priority_mvehicles.mnotes"></editor-field>
...
{label: "Stock#", name:"priority_mvehicles.mstock"},
...
{label: "Description", name:"priority_mvehicles.mannounce"},
...
{
 	text:   'Un-Sell' , 
 	titleAttr: 'Sets Sold Date, Status to A. ',
                action: function ( e, dt, node, config ) {
			editor
			.edit(dt.rows({selected:true}).indexes('mid'), false)
     			.val('priority_mvehicles.mstatus', 'A' )
		.val('priority_mvehicles.msolddate', '' )
     			.submit();},
