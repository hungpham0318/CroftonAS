...
<?php include "../sales/stylehead-end3.html";?>
<body>
...
<fieldset class="hr">
                            <legend>Group A</legend>
                            	...
                            	<editor-field name="priority_dealers.daddress"></editor-field>
                            	<editor-field name="priority_dealers.dcity"></editor-field>
				<editor-field name="priority_dealers.dstate"></editor-field>
				<editor-field name="priority_dealers.dzip"></editor-field>
				...
				<editor-field name="priority_dealers.dcontact"></editor-field>
				<editor-field name="priority_dealers.dsdphone"></editor-field>
				<editor-field name="priority_dealers.dattn"></editor-field>
                            	                     	<editor-field name="priority_dealers.dmailAcctNum"></editor-field>
<editor-field name="priority_dealers.dphone"></editor-field>
                            </fieldset>
                            <fieldset class="office">
                            	<legend>Group C</legend>
                            	
                            	
                            	<editor-field name="priority_dealers.drepfee"></editor-field>
                            	<editor-field name="priority_dealers.drepfeedesc"></editor-field>
                            	<editor-field name="priority_dealers.dnumber"></editor-field>
                            	
                             	
                            </fieldset>
                           <fieldset class="name">
                            	<legend>Group C</legend> 
                       <editor-field name="priority_dealers.dinvoiceemail"></editor-field>
                       <editor-field name="priority_dealers.dnotes"></editor-field>
...
<div id="myModal" class="modal">
  ...
  <!--   <span class="close" id="span">&times;</span>
    ...
    <table style="width:100%;"><thead><th style="width:45%;margin:5px;">Manage User Access</th><th style="width:45%;margin:5px;" >Selected Dealer - User Access</th></thead><tr><td><iframe src="/admin/priority/udrelatejoinpriority.html" width="100%" height="500px"  sandbox="allow-same-origin allow-scripts"></iframe>
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: "dealerspriority.php",
display: 'envelope',
//display: 'lightbox',
       table: "#example",
       template: '#customForm',
       fields: [ 
{"label": "Access No.","name":"priority_dealers.dnumber"},
{"label": "Dealership","name":"priority_dealers.dname"},
{"label": "Address","name":"priority_dealers.daddress"},
{"label": "City","name":"priority_dealers.dcity"},
{"label": "State","name":"priority_dealers.dstate"},
{"label": "Zip","name":"priority_dealers.dzip"},
{"label": "Attn to","name":"priority_dealers.dattn"},
{"label": "Sale-Day Contact","name":"priority_dealers.dcontact"},
{"label": "Sale-Day Phone","name":"priority_dealers.dsdphone"},
{"label": "Mail Acct Info","name":"priority_dealers.dmailAcctNum"},
{"label": "Invoices to:</br> (Comma Separated </br> email addresses)","name":"priority_dealers.dinvoiceemail"},
//{"label": "Default Fee","name":"priority_dealers.drepfee"},
{label: "Default Fee:", type: "select", name: "priority_dealers.drepfee", options: [ "150", "125", "100", "0" ] },
{label: "Fee Description:", type: "select", name: "priority_dealers.drepfeedesc", options: [ 
		"Rep Fee",
		"Rep Fee / Volume",
               "Rep Fee / Value",
               "Rep Fee / Bel Air",
...
//{"label": "Fee Description","name":"priority_dealers.drepfeedesc"},
{"label": "Notes","name":"priority_dealers.dnotes"},
{"label": "Id","name":"priority_dealers.did","type":"readonly" },
...
//order: [[ 19, 'desc' ],[22,'asc']],
   columns: [ 
{data: "priority_dealers.dnumber"},
{data: "priority_dealers.dname"},

{data: "priority_dealers.daddress"},
{data: "priority_dealers.dcity"},
{data: "priority_dealers.dstate"},
{data: "priority_dealers.dzip"},
{data: "priority_dealers.dattn"},



{data: "priority_dealers.dcontact"},
{data: "priority_dealers.dsdphone"},
{data: "priority_dealers.dmailAcctNum"},
{data: "priority_dealers.dinvoiceemail"},
{data: "priority_dealers.drepfee"},
{data: "priority_dealers.drepfeedesc"},
{data: "priority_dealers.dnotes"},

{data: "priority_dealers.did"},
...
//    } );
 // var uda1 = '<iframe sandbox="allow-same-origin allow-modals allow-scripts" src="/admin/sales/dcrelatehtmljs.php?did=';
           var ud1 = '<iframe sandbox="allow-same-origin allow-modals allow-scripts" src="/admin/priority/durelatepriorityhtmljs.php?did=';
var ud2 = 0;
