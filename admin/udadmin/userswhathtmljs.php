...
<tr>
<td style="border:1px solid #660000;min-width:30%;display:inline-block;margin:30px;float:left;"><iframe src="/admin/udadmin/udrelatejoin.html" width="100%" height="500px"  sandbox="allow-same-origin allow-scripts"></iframe></td>
...
<div id="myModal" class="modal">
  ...
  <!--   <span class="close" id="span">&times;</span>
    ...
    <table style="width:100%;"><thead><th style="width:45%;margin:5px;">Manage Dealership Access</th><th style="width:45%;margin:5px;" >Selected User Dealership Access</th></thead><tr><td><iframe src="/admin/udadmin/plainudrelatejoinhtml.php" width="100%" height="500px"  sandbox="allow-same-origin allow-scripts"></iframe>
...
//  .val('users.password', '<?php //$pw = password_hash($ucas, PASSWORD_BCRYPT); //echo $pw;?>')
...
//    } );
  var uda1 = '<iframe sandbox="allow-same-origin allow-modals allow-scripts" src="/admin/udadmin/uarelatehtmljs.php?uid=';
           var ud1 = '<iframe sandbox="allow-same-origin allow-modals allow-scripts" src="/admin/udadmin/udarelatehtmljs.php?uid=';
var ud2 = 0;
var ud3 = '" width="100%" height="500px"  ></iframe>';
   var qdid = 0;
 var qdidurl ='<a href="/admin/udadmin/udarelatehtmljs.php?uid=';
        var qdidurl2 ='">id</a>';
$('#example tbody').on( 'click', 'tr', function () {
        $(this).toggleClass('selected');
