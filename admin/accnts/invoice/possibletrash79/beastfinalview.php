...
<button class="dt-button" type = "submit" >Save and Preview Changes</button><button class="dt-button"  style = "" disabled> Create Invoice and continue </button><button class="dt-button" style = "" disabled>Change Invoice Record</button><button class="dt-button" style = "" disabled>Send Invoice Link</button><br />
</fieldset></form>
