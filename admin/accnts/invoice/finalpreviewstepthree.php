...
$resultin = mysqli_query($con, "INSERT INTO `invoices_temp`(`iid`, `idate`, `itotal`, `ipdfurl`, `iaid`, `idid`, `idname`, `idattn`, `idaddress`,`idcitystatezip`,`idinvoiceemail`,`iclosed`) VALUES (null, '$idate', '$itotal', '$ipdfurl', $iaid, $idid, '$idname', '$idattn', '$idaddress', '$idcitystatezip', '$idinvoiceemail', 0)");
...
$resultic=mysqli_query($con, "SELECT * FROM i_charges_temp WHERE ic_did = $qmdid");
...
/*
include "../../process/connecti.php";
$resultitotal = mysqli_query($con, "UPDATE `invoices_temp` SET `itotal`= $itotal WHERE iid = $qmdid");
...
$URL="/admin/accnts/invoice/finalpreviewview.php?did=$qmdid";
echo "<script type='text/javascript'>document.location.href='{$URL}';</script>";
echo '<META HTTP-EQUIV="refresh" content="0;URL=' . $URL . '">';

//echo'<br><br><a href="beastpreviewview.php?did='.$qmdid.'" target="_blank">Click here to return to invoicing</a><br>';
