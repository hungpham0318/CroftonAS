...
border-radius : 5px;
box-shadow : 0 .5px .5px #ccc inset, 0 .5px 0 #ccc;/**/
display:inline-block;
margin : 0 auto;
  font-size:1em;
  line-height:1em;
...
/*
$resultit=mysqli_query($con, "SELECT * FROM invoices WHERE iid= $nextid");
...
echo '<label class="label-input" style = "position: relative;left:33em;top: -2.6em;width:2em;">Date:</label><br /> <input name ="idate"  value  = "'.$idate.'" type="date" style = "padding:0px!important; margin:0px!important; position: relative;left:36em;top:-4.6em!important;height:2em; width:9.5em!important;"><br />
...
$resultic=mysqli_query($con, "SELECT * FROM i_charges WHERE ic_iid = $nextid ");
...
<iframe src="NoInvoiceYet.jpg" width="100%" height="1024px" style="valign:top;" allow-forms allow-top-navigation allow-popups allow-same-origin allow-scripts allow-pointer-lock name="" onError="location.href='NoInvoiceYet.jpg'">
  <p>Your browser does not support iframes.</p>
</iframe></p>
<img src="invimage.jpg" width="1" height="1" style="visibility:hidden" onError="document.getElementById('iframe').innerHTML = '<img src='NoInvoiceYet.jpg'>'">
 <!---->
</td></tr>
</tbody>
</table>
