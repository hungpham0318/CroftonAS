...
?>
  <tr id="rows" style = "border:1px solid #000000;"><td><input name="icnum'<?php echo $x;?>" value="<?php echo $x;?>" style="width: 3em;"></td>
<?php echo '
...
<button class = "dt-button" type = "submit" > Submit</button><button style = "" disabled> Recreate Invoice</button><button style = "" disabled>Change Invoice Record</button><button style = "" disabled>Send Invoice Link</button><br />
</fieldset></form>
