...
$resultin = mysqli_query($con, "INSERT INTO `invoices`(`iid`, `idate`, `itotal`, `ipdfurl`, `iaid`, `idid`, `idname`, `idattn`, `idaddress`,`idcitystatezip`,`idinvoiceemail`,`iclosed`) VALUES (null, '$idate', '$itotal', '$ipdfurl', $iaid, $idid, '$idname', '$idattn', '$idaddress', '$idaddress2', '$idinvoiceemail', 0)");

// mysqli_query returns false if something went wrong with the query
if($result2 === FALSE) { echo 'WAHHHHHHH1 died at line 74 insert invoices query result2 which means there is no iid defined henceforth';
...
include "../../process/connecti.php";
$resultitotal = mysqli_query($con, "UPDATE `invoices` SET `itotal`= $itotal WHERE iid = $iid");
...
//include "../../caslog/includes/config.php";
$SITEEMAIL='croftona@croftonas.com';
$damnurl = "";
$cc = "suzannenbird@gmail.com,suzianne@croftonas.com";
...
$styleinfo ='style="font-size:16px;font-family:Tahoma, Geneva, sans-serif;font-weight: 600;"';
			...
			<p $styleinfo>I need you to dictate this text:  Use this link to view, print, and save this invoice. <a href=".$ipdfurl.">$ipdfurl</a></p>
			<p $styleinfo>Invoice Id:&nbsp;$iid</p>
			<p $styleinfo>Invoice Date:&nbsp;$idate</p>
			<p $styleinfo>Emailed to :&nbsp;$idinvoiceemail</p>
			<p $styleinfo>Amount:&nbsp;$ffinitotal</p>
...
$URL="/admin/sales/steponehtmljs.php?msg=1&idid=$idid&iid=$iid";
