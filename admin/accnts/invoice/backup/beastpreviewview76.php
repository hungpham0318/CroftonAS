...
<button class="dt-button" name = "submit" type = "submit" >Save and Preview Changes</button><button class = "dt-button" onclick="window.location='http://www.croftonas.com/admin/accnts/invoice/beastfinalstepthree.php?did=<?php echo $qmdid;?>';" disabled>final Invoice</button><!--<button class="dt-button" style = "" disabled>Start Over</button><button class="dt-button" style = "" disabled>Send Invoice Link</button><br />-->
</fieldset></form>
