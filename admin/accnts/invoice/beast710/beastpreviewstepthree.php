...
$resultin = mysqli_query($con, "INSERT INTO `test_invoices_temp`(`iid`, `idate`, `itotal`, `ipdfurl`, `iaid`, `idid`, `idname`, `idattn`, `idaddress`,`idcitystatezip`,`idinvoiceemail`,`iclosed`) VALUES (null, '$idate', '$itotal', '$ipdfurl', $iaid, $idid, '$idname', '$idattn', '$idaddress', '$idcitystatezip', '$idinvoiceemail', 0)");
...
include "../../process/connecti.php";
	...
	//$deleterecords = "TRUNCATE TABLE test_i_charges_temp"; //empty the table of its current records
...
$URL="/admin/accnts/invoice/beastpreviewview.php?did=$qmdid";
