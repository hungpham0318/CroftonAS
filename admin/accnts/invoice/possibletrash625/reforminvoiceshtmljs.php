...
<fieldset class="hr" ><legend>Invoice Fields</legend>
...
<!--
<fieldset class="hr"><legend></legend>
...
<editor-field name="i_payments.ip_xtra"></editor-field>
   ...
   <table style="width:100%;"><tr><th></th></tr>
   <tr>
   <td>
 <iframe src="reformsnip.php?iid=<?php echo $qiid;?>" width="100%" height="512px" style="valign:top;" allow-forms allow-top-navigation allow-popups allow-same-origin allow-scripts allow-pointer-lock name="">
...
{label:  "invoices.iclosed", name:"invoices.iclosed"}
 ...
 ajax: "reforminvoicephp.php?iid=<?php echo $qiid;?>",
display: 'envelope',
//display: 'lightbox',
       table: "#example",
       template: '#customForm',
...
//		},
//{
 //	text:   '<?php if($qipid < -1){echo"Choose a payment row";}else{echo "Mark Selected as Paid with PaymentId: ".$qipid;}?>' , 
