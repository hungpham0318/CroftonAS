...
$qmdid=mysqli_real_escape_string($con, $qmdid);
...
<tbody><tr><td style="vertical-align:top;"><form id="invcorrect" method="post" action = "steptwopostprocess.php" >';
