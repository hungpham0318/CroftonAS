...
echo'<tr id="rows">
<td><input name="ic_id'.'.'.$x.'" value="" type="hidden" readonly>
	<input name="ic_iid'.'.'.$x.'" value="" type="hidden" readonly>
	
	<input id="'.$x.'" name= "delete'.'.'.$x.'" type="checkbox" value="" onclick="myCheck()" style="width: 2em;"></td>
<td><input name="ic_description'.'.'.$x.'" value="" style="width: 24em;"></td>
<td><input name="ic_ratedesc'.'.'.$x.'" value="" style="width: 13em;"></td>
<td><input name="ic_qty'.'.'.$x.'" value="" style="width: 3em;"></td>
<td><input name="ic_rate'.'.'.$x.'" value="" style="width: 4em;"></td>
<td><input name="ic_amount'.'.'.$x.'" value="" style="width: 5em;"></td></tr>';
echo '<tbody>';
 $x=1;  
