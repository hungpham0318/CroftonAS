...
<div id = "btncreate"><button style = "position: absolute;left: 12em;top: 39em;" title="When you create a new row, or change values in the row, the totals also need to be updated on this form...for a little while...until the juice is worth the squeeze, anyway" onclick="myCreateFunction()">Create row</button></div><div id = "btnappend"><button style = "position: absolute;left: 12em;top: 39em;" title="When you create a new row, or change values in the row, the totals also need to be updated on this form...for a little while...until the juice is worth the squeeze, anyway" onclick="myCreateFunction()">Create row</button></div>
<?php
include "../../process/connecti.php";
...
<tbody><tr><td style="vertical-align:top;"><form id="invcorrect" method="post" action="arraynamespost.php?did=<?php echo $idid;?>" >
...
// as of php 5.4 foreach
echo '<br /><table id="myTable" style ="width:45%;border: 1px solid #000000;/*position:absolute;*/top:50em;"><thead> <tr id="rows"><th></th><th></th><th></th><th>Qty</th><th>Rate</th><th>Amount</th><th></th></tr>';
...
$icnum = $x;
 echo'
 <tr  style = "border:1px solid #000000;"><td><input name="ic_id'.$x.'" value="'.$x.'" style="width: 3em;"></td>
...
<?php
$icnum	=$x;
$icnumdata = '<tr id = "rows"><td><input name="icnum'.$x.'" value="'.$icnum.'" style="width: 3em;"></td>';
...
$myreadonly = '<td> <input name="ic_iid'.$x.'" value="'.$iid.'" type="hidden" readonly><input name="ic_mid'.$x.'" value="" type="hidden" readonly><input name="ic_date'.$x.'" value="'.$idate.'" type="hidden" readonly><input name="ic_solddate'.$x.'" value="" type="hidden" readonly><input name="ic_maid'.$x.'" value="'.$iaid.'" type="hidden" readonly><input name="ic_stock'.$x.'" value="" type="hidden" readonly><input name="ic_paid'.$x.'" value="0" type="hidden" readonly><input name="ic_note'.$x.'" value="" type="hidden" readonly><input name="ic_xtraint'.$x.'" value="" type="hidden" readonly><input name="ic_price'.$x.'" value="" type="hidden" readonly></td></tr>';
...
function myCreateFunction() {
	...
	ic_description.innerHTML = '<td style="text-transform:uppercase;"><input name="ic_description'+x+'" value="" style="text-transform:uppercase;width: 24em;"></td>';
        ...
        invreadonly.innerHTML ='<td> <input name="ic_iid'+x+'" value="<?php echo $iid;?>" type="hidden"><input name="ic_mid'+x+'" value="" type="hidden"><input name="ic_date'+x+'" value="<?php echo $idate;?>" type="hidden"><input name="ic_solddate'+x+'" value="" type="hidden"><input name="ic_maid'+x+'" value="<?php echo $iaid;?>" type="hidden"><input name="ic_stock'+x+'" value="" type="hidden"><input name="ic_paid'+x+'" value="0" type="hidden"><input name="ic_note'+x+'" value="" type="hidden"><input name="ic_xtraint'+x+'" value="" type="hidden"><input name="ic_price'+x+'" value="" type="hidden"></td>';
}
...
$(document).on("click",'#mybtn',function(){	
    var datatoadd='<tr id = "rows"><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6 </td><td>7</td></tr>';
