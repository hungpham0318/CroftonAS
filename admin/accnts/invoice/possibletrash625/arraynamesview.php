...
<tbody><tr><td style="vertical-align:top;"><form id="invcorrect" method="post" action="arraynamespost.php?did=<?php echo $qmdid;?>" >
...
?>
  <tr id="rows" style = "border:1px solid #000000;"><td><input name="ic_id[]" value="<?php echo $x;?>" style="width: 3em;"></td>
<?php echo '
