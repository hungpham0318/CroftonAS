...
// as of php 5.4 foreach
echo '<br /><table id="myTable" style ="width:45%;border: 1px solid #000000;/*position:absolute;*/top:50em;"><thead> <tr><th>#</th><th>Description</th><th>rd</th><th>Qty</th><th>Rate</th><th>Amount</th><th>hidden</th></tr></thead>';
...
?>
  <tr id="rows_<?php echo $x;?>" style = "border:1px solid #000000;"><td><input name="ic_id<?php echo $x;?>" value="<?php echo $x;?>" style="width: 3em;"></td>
<?php echo '
<td style="text-transform:uppercase!important;"><input name="ic_description'.$x.'" value="'.$row['ic_description'].'" style="text-transform:uppercase!important;width: 24em;"></td>
	...
	<td><input name="ic_did'.$x.'" value="'.$row['ic_did'].'" type="hidden" ></td>
	<td><input name="ic_iid'.$x.'" value="'.$row['ic_iid'].'" type="hidden"></td>
	
	<td><input name="ic_mid'.$x.'"  value="'.$row['ic_mid'].'" type="hidden" ></td>
	<td><input name="ic_date'.$x.'" value="'.$row['ic_date'].'" type="hidden"></td>
	<td><input name="ic_solddate'.$x.'"  value="'.$row['ic_solddate'].'" type="hidden" ></td>
	<td><input name="ic_maid'.$x.'" value="'.$row['ic_maid'].'" type="hidden"></td>
	<td><input name="ic_stock'.$x.'"  value="'.$row['ic_stock'].'" type="hidden" ></td>
	<td><input name="ic_paid'.$x.'" value="'.$row['ic_paid'].'" type="hidden"></td>
	<td><input name="ic_note'.$x.'" value="'.$row['ic_note'].'" type="hidden"></td>
	<td><input name="ic_xtraint'.$x.'"  value="'.$row['ic_xtraint'].'" type="hidden"></td>
	<td><input name="ic_price'.$x.'" value="'.$row['ic_price'].'" type="hidden" ></td>
...
{"label": "Dealer. Id","name":"i_charges.ic_did"},
