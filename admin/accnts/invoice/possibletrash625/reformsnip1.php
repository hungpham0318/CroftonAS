...
echo'
  <tr id="rows" style = "border:1px solid #000000;">
   <td><input name="icnum'.$icnum.'.'.$x.'" value="'.$icnum.'" style="width: 3em;"></td>
...
<button style = "position: absolute;left: 3em;top: 38em;" onclick="myCreateFunction()">Create row</button>
<?php
$icnum	=$x;
...
$mycheckdata='<td><input name="ic_chick'.$x.'" id="mychick'.'.'.$x.'" type="checkbox" value="" onclick="mychick()" style="width: 2em;">';
...
function myCreateFunction() {
    ...
    mychick.innerHTML = '<?php echo $mycheckdata;?>';
}
function mychick() {
