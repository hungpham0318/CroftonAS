...
if(empty($idinvoiceemail)){if(empty($newinvoiceemail)){echo "<br />No email recipients found!  <br />This invoice was previously emailed to CAS recipients only!<br />  Enter email address(es)<br /> into the Dealership Record, then reopen or refresh this page.";}else{$idinvoiceemail="CAS recipients only.";}}
if($idinvoiceemail !== $newinvoiceemail){
echo "Email addresses have changed!<br>

This invoice was previously emailed to: ".$idinvoiceemail; 
$idinvoiceemail = $newinvoiceemail;
echo "<br/> The email address in the invoice record will be updated when the email is sent.<br />";
...
echo"This email will be sent to: ";
if($idinvoiceemail !== ''){echo $idinvoiceemail;}else{echo "Nobody!  Enter an email address in the Dealership record and then reopen or refresh this page.";} ?>
