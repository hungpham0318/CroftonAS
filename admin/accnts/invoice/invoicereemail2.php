...
if($resultem === FALSE) { 
     die(mysqli_error($con)."<b><br>
     <br>query begins line 58 - This error invoice query  resultem </b>");
    //or die(mysql_error($con));
}
else {//echo 'line 49 <br>';
// as of php 5.4 foreach
...
$resultupem=mysqli_query($con, "UPDATE `invoices` SET `idinvoiceemail`= '$idinvoiceemail' WHERE iid = $qiid");

// mysqli_query returns false if something went wrong with the query
if($resultupem === FALSE) { echo '<br>invoice email record was not updated resultupem </b>'.mysqli_error($con).'<b><br>';
			...
			//$to = "miked@croftonas.com,".$idinvoiceemail;
 			$subject = "Reminder: Invoice# ".$iid." - Crofton Auction Services";
			$message = "
			<p $styleinfo>Outstanding Invoice Reminder</p>
...
//$headers .= 'BCC: invoices@croftonas.com, suzianne@croftonas.com'."\r\n";
