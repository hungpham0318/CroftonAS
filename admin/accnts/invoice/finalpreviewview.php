...
<div id="customForm">
                        <fieldset class="hr" disabled readonly>
                            <legend>Do Not Change(i.e. won't disable)</legend>
...
$resultit=mysqli_query($con, "SELECT * FROM invoices_temp WHERE idid = $qmdid");
...
if(empty($idinvoiceemail)){if(empty($newinvoiceemail)){echo "<br />No email address found!  <br />This invoice will only be emailed to CAS recipients!<br />  If this is not intentional, enter email address(es) below.  Be advised that email addresses added in this view will only apply to this invoice.  Permanent dealer email addresses should be entered into the Dealer's record. <br /> Be sure to save and preview the changes before sending.";}}
if($idinvoiceemail !== $newinvoiceemail){$idinvoiceemail = $newinvoiceemail;
 ...
 ?>
<br /><table id ="maintable" style = "width:100%;margin-left:3%"><thead><tr><br /><th style = "width:48%!important;" ></th><th style = "width:48%!important;" ></th></tr></thead>
<tbody><tr><td style="vertical-align:top;"><button class = "" style = "width:95%;font-size:14px; padding:6px;" " onclick="window.location='http://www.croftonas.com/admin/accnts/invoice/finalizeinvoice.php?did=<?php echo $qmdid;?>';" >Finalize This Invoice</button>
<br /><form id="invcorrect" method="POST" action="finalpreviewpost.php?did=<?php echo $qmdid;?>" >
<img src = "invimage.png" style = "margin-left: -3em;width:95%;"><br />
<label class="label-input" style = "position: relative;left:60%;top: -2.6em;width:2em;">Date:</label><br /> <input name ="idate" value = "<?php echo $idate;?>" type="date" style = "padding:0px!important; margin:0px!important; position: relative;left:67%;top:-4.6em!important;height:2em; width:9em!important;"><br />
...
<div style = "width:95%"><table id="myTable" style ="width:100%;border: 1px solid #000000;top:50em;font-size:.8em;">
...
<label class="label-input" style = "";">Invoice Link</label><a target="_blank" href ="<?php echo $ipdfurl;?>"><input name ="ipdfurl"  value = "<?php echo $ipdfurl;?>" type="url" style="width:70%;text-transform:lowercase!important;"></a><br />
...
<button class="dt-button" name = "submit" type = "submit" >Save and Preview Changes</button>
</fieldset></form><br />

<!--<button class = "dt-button" onclick="window.location='http://www.croftonas.com/admin/accnts/invoice/finalprecreator.php?did=<?php echo $qmdid;?>';">Re-create Invoice</button>-->
</td> <td><p id="iframe" align="center">
<iframe id = "iframe" src="preview/<?php echo $qmdid;?>.pdf" width="600px" height="1024px" style="valign:top;" >
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: 'finalpreviewphp.php?did=<?php echo $qmdid;?>',
        table: '#myTable',
        display: 'lightbox',
      template: '#customForm',
       sort: false,
