...
if (empty($ic_qty)) {
 echo'<div id="ic_qty"><label>Qty:</label><br><input name="ic_qty" placeholder="1" type="text" value="1"/></div>';
}else{
echo'<div id="ic_qty"><label>Qty:</label><br><input name="ic_qty placeholder="'.$ic_qty.'" type="text" value="'.$ic_qty.'"/></div>';
}

if (empty($ic_rate)) {echo'<div id="ic_rate"><label>Rate:</label><br><input name="ic_rate" placeholder="150" type="text" value="150"/></div>';
...
<div id="idattn"><label>Attention:</label><br><input name= "idattn" placeholder="Attention: <?php echo $idattn;?>" type="text" value="<?php echo $idattn;?>" /></div>

<?php if (empty($msolddate)) {echo'<div id="msolddate"><label>Date:</label><br><input name="msolddate" placeholder="'.$idate.'" type="text" value="'.$idate.'"/></div>';
}else{echo'<div id="mssolddate"><label>Sold Date:</label><br><input name="msolddate" placeholder="'.$msolddate.'" type="text" value="'.$msolddate.'"/></div>';}?>

<div id="idate"><label>Sold Date:</label><br><input name="idate" placeholder="Invoice Date:<?php echo $idate;?>" type="text" value="<?php echo $idate;?>"  /></div>

<div id="ic_notes"><label>Notes:</label><br><input name="ic_notes" placeholder="What is typed here will show directly under the charge(s) table, and/but is not recorded" type="text" value="What is typed here will show directly under the charge(s) table, and/but is not recorded"/></div>
</div>
