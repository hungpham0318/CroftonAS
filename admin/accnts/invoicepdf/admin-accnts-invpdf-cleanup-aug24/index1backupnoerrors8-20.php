...
//$resultmu = mysqli_query($con, "REPLACE INTO `master`(`mstatus`, `msubstatus`, `msolddate`, `minvid`,`marchive`) VALUES ('S','inv-sent','$msolddate','$qiid' WHERE `mid` = $qmid");
$resultmu = mysqli_query($con, "UPDATE master SET mstatus='S',msubstatus='inv-sent',msolddate='$msolddate', minvid='$minvid', `marchive` = 0 WHERE mid = $mmid");
