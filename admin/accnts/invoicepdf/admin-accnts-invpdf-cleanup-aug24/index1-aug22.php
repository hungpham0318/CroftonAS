...
$resultmstr = mysqli_query($con, "SELECT `mid`, `mvid`, `maid`, `muid`, `mdid`, `mvin`, `myear`, `mmodel`, `mstock`, `mstatus`, `msubstatus`, `msolddate`, `minvid`, `did`,`dnumber`,`dname`,`daddress`,`dcity`,`dstate`,`dzip` 
FROM master, dealers WHERE `mdid` = $qmdid AND `minvid` = 0 AND `mstatus`='A'");
...
if($resultmu === FALSE) { echo 'line 288<br>';
      die(mysqli_error($con));
}
echo 'line 288<br>';
