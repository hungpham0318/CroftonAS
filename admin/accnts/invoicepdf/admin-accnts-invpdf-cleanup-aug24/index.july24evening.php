...
$ic_amount = 0;
//$year = substr($myear, -2);
$ic_description = substr($myear, -2)." ".$mmodel." ".substr($mvin, -8)." ".$msolddate." ".$mstock;
$ic_solddate = $row['msoldate'];
//$ic_qty = $row['iid'];
//$ic_rate = 
$ic_maid = $row['maid'];
...
$pdf->Cell(50,7,$rate,1,0,'L',0);
$pdf->Cell(20,7,$qty,1,0,'L',0);
...
echo "Attn: "."$dattn"."          Item:   "."$ic_description"."           Sold Date: "."$ic_description";
echo "$daddress"."           "."$ic_amount";
echo "$iid";
echo "$ic_id";
echo "$ic_date";
echo "$ic_solddate";
...
<div id="iid"><input name="iid" placeholder="Invoice number: <?php echo $iid;?>" type="text" value="<?php echo $iid;?>"></div>
<div id="ic_description"><input name="ic_description" placeholder="Item: <?php echo"$ic_description";?>" type="text" value="<?php echo"$ic_description";?>"  /></div>
<div id="dattn"><input name="dattn" placeholder="Attention: <?php echo"$dattn";?>" type="text" value="<?php echo"$dattn";?>" /></div>
<div id="daddress"><input name="daddress" placeholder="Address: <?php echo $daddress;?>" type="text" value="<?php echo $daddress;?>"  /></div>
<div id="daddress2"><input name="daddress2" placeholder="City State Zip: <?php echo $dcity." ".$dstate." ".$dzip;?>" type="text" value="<?php echo $dcity." ".$dstate." ".$dzip;?>"  /></div>
</div>
<div id="body_r">
<div id="Price"><input name="price" placeholder="Amount: <?php echo"$ic_amount";?>" type="text" value="150.00"/></div>
<div id="ic_date"><input name="ic_date" placeholder="Date Sold:<?php echo"$msolddate";?>" type="text" value="<?php echo $msolddate;?>"  /></div>

<div id="notes"><input name="notes" placeholder="Additional note for this invoice." type="text" value="<?php echo"$notes";?>"  /></div>
</div>
