...
echo "</br>";
echo "</br>";
}else{$apndx=substr($j, -2);}
echo $apndx;
$ic_icid = $ic_icid.".".$ic_icid;
echo $ic_icid. "<-- value of ic_icid at line 166";
...
//query for last invoice created immediately subsequent to insertion of the new invoice record
//$ic_iid= 
...
//insert query for creation of the rows of invoice items using the iid as part of the ic_icid  along with 0-9

//$ic_icid= $iid.$j/10;

//iic_icid_subzero = 2 decimal places with leading decimal for (j/10)
//(or I may have to substr(subzero,-3) 
