...
<div id="body_l">
<div id="name"><input name="company" placeholder="From: <?php echo"$company";?>"  value="<?php echo"$company";?>" type="text" /></div>
...
<div id="name"><input name="idate" placeholder="Invoice Date:" type="text" value="<?php echo"$daddress";?>"  /></div>
