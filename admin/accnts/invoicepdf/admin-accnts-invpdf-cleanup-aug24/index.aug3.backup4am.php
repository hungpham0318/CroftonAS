...
include "../../process/connecti.php";
//$qmid = mysqli_real_escape_string($con, $_GET['mid']);
$result2 = mysqli_query($con, "INSERT INTO `invoices`(iid, `idate`, `itotal`, `ipdfurl`, `iaid`, `idid`, `idname`, `idattn`, `idaddress`,`idcitystatezip`) VALUES (null, '$idate', '$itotal', '$ipdfurl', $iaid, $idid, '$idname', '$idattn', '$idaddress', '$idaddress2')");
...
$minvid = $iid;
$iidname= $iid;
$ipdfurl = "http://www.manheimas.com/admin/accnts/invoicepdf/".$last_id.".pdf";
...
$qiid = mysqli_real_escape_string($con, $qiid);
