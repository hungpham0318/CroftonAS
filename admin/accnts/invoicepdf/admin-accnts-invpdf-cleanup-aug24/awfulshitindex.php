...
if($result === FALSE) { 
     die(mysqli_error($con)."master query failed<br>query begins line 15 - This error probably means no record number was sent -or- it cannot find the record that matches the record sent in the url</b>");
...
<br>
<div id="up" class=""  align="center"><input name="submit" style="margin-top:60px;" value="Create Invoice" type="submit" onclick='document.getElementById("up").className = "hidden";'  /><br /><br />
</div>
