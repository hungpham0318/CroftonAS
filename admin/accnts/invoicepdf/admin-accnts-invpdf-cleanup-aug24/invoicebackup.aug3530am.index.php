...
//$resultmu = mysqli_query($con, "REPLACE INTO `master`(`mid`,`mstatus`, `msubstatus`, `msolddate`, `minvid`) VALUES ('S','inv-yes','$msolddate','$qiid' WHERE `mid` = $qmid");
$resultmu = mysqli_query($con, "UPDATE master SET mstatus='S',msubstatus='inv-open',msolddate='$msolddate', minvid='$minvid' WHERE mid = '$mmid'");
...
//update mi_relate
include "../../process/connecti.php";
$mi_iid = mysqli_real_escape_string($con, $mi_iid);
$mi_mid = mysqli_real_escape_string($con, $mi_mid);
...
$di_did = mysqli_real_escape_string($con, $idid);
