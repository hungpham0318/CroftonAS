<?php 
// admin/accnts/invoicepdf/invprocess1.php
...
$resultmu = mysqli_query($con, "UPDATE master SET mid = $mid, maid = $maid, muid = $muid, mdid = $mdid, mvin = '$mvin', myear = $myear, mmodel = '$mmodel', mstock = '$mstock', mstatus = '$mstatus', msubstatus = '$msubstatus', msolddate = '$msolddate', msoldprice = '$msoldprice', minvid = $minvid WHERE `master`.`mid` = $mmid");
