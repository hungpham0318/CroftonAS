...
<div id="body_l">
<div id="name"><input name="company" placeholder="" type="text" value="Crofton Auction Services" /></div>
<div id="name"><input name="address" placeholder="" value="5 Park Place Suite 519" type="text" /></div>
<div id="name"><input name="address2" placeholder="Annapolis, MD 21401" type="text" /></div>
...
<div id="footer" align="center">.<a href="http://www.croftonauctionservices.com" target="_blank">Crofton Auction Services</a></div>
</body>
</html>
