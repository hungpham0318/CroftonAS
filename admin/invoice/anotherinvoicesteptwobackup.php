...
$ic_description = substr($myear, -2)." ".$mmodel." ".substr($mvin, -8)." ".$mstock;
...
echo "<br> at line 300 the iid= ".$iid;
$ipdfurl = 'http://www.manheimas.com/admin/accnts/invoice/bunker/'.$idid.'.'.$iid.'.pdf';
/**/
