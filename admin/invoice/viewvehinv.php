...
<link rel="stylesheet" href="../Editor/css/editor.dataTables.min.css">
		...
		<link rel="stylesheet" href="/admin/worldview/css/world-admin.css" type="text/css">
		<link rel="stylesheet" href="/admin/worldview/css/world-login.css" type="text/css">
<link rel="stylesheet" href="../worldview/css/snow-nav-admin.css">
<link rel="stylesheet" href="../worldview/css/wraptable-page.css">
<link rel="stylesheet" href="../worldview/css/status-key.css">
<link rel="stylesheet" href="../worldview/css/substatus-key.css">
...
<div class="worldbannerline"><img class="worldbannerline" src="/images/croftonasbanner3.png"  alt="crofton auction services banner for website" /><?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	...
	include '../worldview/css/substatus-key.html';
	echo'</div>';
	 }?></div>
...
<div class="wbannerline">
	...
	{echo'<div class="wbannerline"></div><div class="wbannerline" style="float:right;" width:18%">';
			include '/admin/worldview/forms/li-form.html';
			echo"</div></div></div><!--NOT logged in and close div after login form displayed-->";
	}
	else{
		$bar = $ausername;
		include '../worldview/css/status-key.html';
	...
	<?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	{}else{ include '../invoice/views/vehinvhtml.html';
