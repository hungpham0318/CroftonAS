...
<div class="wbannerline">
	...
	{echo '<p>Log in to see contents</p><a href="/admin/worldview/index.php">Click to log in</a></div><!--sect1leftcolcomingfromifNOTloggedin=cannot go past-->';}else{echo '</div><!--sect1leftcolcomingfromifISloggedin=close-div-andcontinue-->';} ?>

	<?php if(!isset($_SESSION['ausername']) || $_SESSION['ausername']=="")
	{}else{ include 'views/dealershtmlrelate.html';
