    ...
    echo "</select>";
      // mysql_close(); 
       echo' </td></tr><tr><td></br>&nbsp;</td></tr><tr>
                        <td>
                        <button type="submit" name="add" class = "" formaction="/admin/process/addarelates.php">Add</button>&nbsp;&nbsp;&nbsp;
<button type="submit" name="delete" class = "" formaction="/admin/process/delete-a-relate.php">Delete</button></td></tr><tr>
<td></br>
...
<td><table width="400">
 ...
 //while($row = mysql_fetch_array($result)){
    ...
    <tr>
                        ...
                        <td><select id="a_id" name="a_id" tabindex="1" width="250px">
