...
return '<a href="/admin/sales/createinvoicehtmljs.php?did=' + data.did+ '">Invoice</a>'; }},
...
{ "data": function (data, type, row, meta) {rowId: 'dealers.did'
//var invoicecount = 2;
return '<a href="/admin/snipstuff/editdealerfromstepone.php?did=' + data.did+ '"> Check Dealer Info</a>'; }},
