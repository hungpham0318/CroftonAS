...
{ "data": function (data, type, row, meta) {rowId: 'dealers.did'
//return '<?php include "kountinvoices.php";?>'; 
return "<?php $k ='+data.dealers.did+'; myKount($k);?>"; 
}
},
...
//$sql="SELECT count(mid)  FROM master WHERE mstatus = 'S' AND msubstatus LIKE '%Inv-No%' AND mdid ='.$k.'";
$sql="SELECT mid  FROM master WHERE mstatus = 'S' AND msubstatus LIKE '%Inv-No%' AND mdid ='.$k.'";
