...
if(!isset($_SESSION['ausername']) || $_SESSION['perms'] < $pageperms){header('Location: ../worldview/index.php?msg=Please_Log_In_to_continue!');}else{
...
{label: "Status:",
 ...
 { label: 'A | Active | Ready at Auction', value: 'A' },
 { label: 'S | Sold | Sold at Auction', value: 'S' },
  ...
  { label: 'X |  | ', value: 'X' }
           ...
           {label: "Substatus:",
                ...
                name: "master.msubstatus",
                 options: [
 { label: 'Recon-Red | Not Yet delivered', value: 'recon-red' },
 { label: 'Recon-Yellow | Shop Has Vehicle', value: 'recon-yellow' },
 { label: 'Recon-Green | Ready at Auction', value: 'recon-green' },
 { label: 'Recon-Blue | Not Coming', value: 'recon-blue' },
