...
<table id="paymenttableiid" class="display compact" cellspacing="0" width="100%">
                    <thead>
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: "paymentsteponesnipphp.php?iid=<?php echo $qiid.'&ipid='.$qipid;?>",
display: 'envelope',
//display: 'lightbox',
       table: "#paymenttableiid",
...
var table = $('#paymenttableiid').DataTable( {
         dom: "Bfrti",
        ajax: "paymentsteponesnipphp.php?iid=<?php echo $qiid.'&ipid='.$qipid;?>",
//"scrollY": 700,
   // responsive: true,
...
//example.ajax.url( '/paymentsteponephp.php?iid=<?php echo $qiid;?>&ipid='+rowData.id ).load();
//} );
