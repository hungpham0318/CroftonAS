...
<editor-field name="master.mready"></editor-field>
    ...
    <!-- Link trigger modal -->
     <button style = "font-size: .8em;"class="button dt-button ">
<a href="../ohajaxmasterlog.php" data-toggle="modal" data-target="#myModal3" data-remote="false" class="button dt-button">
 Change History
</a></button>

<!-- Default bootstrap modal example -->
<div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:30%;margin-left:50%; z-index:1;">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php include"masterlogmodal.php"?>
      </div>    
      </div>
...
<script src="https://code.jquery.com/jquery-3.1.1.slim.min.js" integrity="sha384-A7FZj7v+d/sdmMqp/nOQwliLvUsJfDHW+k9Omg/a/EheAdgtzNs3hpfag6Ed950n" crossorigin="anonymous"></script>
 ...
 <table id="wrapforlog"><tr style="width:100%; display:block;"><td>
<table id="example" class="display compact" style="display:block!important;valign:top!important;" width="100%">
                    <thead>
                        <tr>
<th>ID</th>
<th>RID#</th>
...
<th>READY</th>
	...
	<p style = "display:none;font-size: .8em;" id="masterlog"></p>
...
new $.fn.dataTable.Buttons( table, {
  ...
  header: true,
   ...
   title: '<?php echo"Sale-Day Worksheet Maybe";?>',
   orientation: 'landscape',
...
function loadDoc() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("masterlog").show.innerHTML = this.responseText;
    }
  };
