...
i18n: {
            ...
            remove: {
                ...
                submit: "Supprimer",
                confirm: {
                    _: "Are you sure you want to delete %d Dealer?",
...
//$('td', row).attr('title','The information in Auction, Registrant, and Dealership columns is only editable when using the checkbox selector and the Edit button.');
  ...
  //if ( data.master.msubstatus =='Inv-No' ){ 
   ...
   //}
          ...
          var ud1 = '<iframe src="/admin/snipstuff/udrelatejoin.html?did=';
var ud2 = 1000;


var ud3 = '" width="100%" height="500px"  sandbox="allow-same-origin allow-scripts"></iframe>';
   var qdid = 1000;
 var qdidurl ='<a href="/admin/snipstuff/dcrelatejoin.html?did=';
        var qdidurl2 ='">id</a>';
