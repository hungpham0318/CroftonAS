...
->where( function ( $q ) {
 ...
 // $q->where( 'i_payments.ip_iid', '(SELECT iid FROM invoices WHERE invoices.iid = i_payments.ip_iid)', 'IN', false );
//   $q->where('i_payments.ip_iid', $_GET['iid'],'=');
})
