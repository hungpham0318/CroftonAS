...
echo "</br>";
echo "</br>";
echo"<table><thead><th>Item</th><th>Description</th><th>qty</th><th>Rate</th><th></th><th>Amount</th></thead><tbody>";

$x=0;

foreach ($ichargeArr as $ichargeEntry){
$x = $x+1;
echo "<tr><td>".$x."</td><td>".$ichargeEntry[0]."</td><td>".$ichargeEntry[5]."</td><td>".$ichargeEntry[6]."</td><td></td><td>".$ichargeEntry[7].".00</td></tr>";
}
