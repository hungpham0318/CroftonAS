...
<h2> User Access for Dealerships and Auctions</h2>
<div id="frame-udrelates" style="color:#660000;border:1.5px solid #660000;width:100%;margin-top:30px;display:block;">
<h2>&nbsp;</h2>
<table style="width:100%;"><tr style="width:100%;display:block;"> 
<td style="width:45%;display:block;margin:0 auto;text-align: center;float:left;">Dealerships</td>
<td style="width:45%;display:block;margin:0 auto;text-align: center;float:right;">Auctions</td>
</tr>
...
//display: 'lightbox',
       ...
       template: '#customForm',
       fields: [ 
{"label": "users.uid","name":"users.uid"},
{"label": "users.uname","name":"users.uname"},
{"label": "users.email","name":"users.email"},
{"label": "users.umobile","name":"users.umobile"},
{"label": "users.ufax","name":"users.ufax"},
{"label": "users.uofficeph","name":"users.uofficeph"},
{"label": "users.username","name":"users.username"},
{"label": "users.password","name":"users.password"},
{"label": "users.active","name":"users.active"},
...
{"label": "users.unotes","name":"users.unotes"},
{"label": "users.uperms","name":"users.uperms"},
{"label": "users.ucas","name":"users.ucas"},
{"label": "users.ufirst","name":"users.ufirst"},
{"label": "users.ulast","name":"users.ulast"},
