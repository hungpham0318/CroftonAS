...
<iframe src="/admin/sales/paymentsteponesniphtmljs.php?iid=<?php echo $qiid;?>" style="border:5px normal #440000;width:100%; margin:0 auto;height:400px;"  sandbox="allow-same-origin allow-scripts"></iframe></div>
