...
<!--<a href="/admin/accnts/invoice/steponeinvoice.php" target="_blank">See this in the new and improved invoice view; it's coming real soon!</a>-->
...
$result3 = mysqli_query($con, "SELECT `mid`, `maid`, `muid`, `mdid`, `mvin`, `myear`, `mmodel`, `mstock`, `mstatus`, `minvid`, `msubstatus`, `msolddate`,`msoldprice`, `mrepfee`,`mrepfeedesc`
FROM master WHERE mdid = $did  AND mstatus = 'S'  AND msubstatus = 'Inv-No'");
...
//echo "at line 249(createinvoicehtml.js.php).. the iid= ".$iid;
//echo "<br>";
...
$result2 = mysqli_query($con, "INSERT INTO `invoices_temp`(`iid`, `idate`, `itotal`, `ipdfurl`, `iaid`, `idid`, `idname`, `idattn`, `idaddress`,`idcitystatezip`, `idinvoiceemail`, `iclosed`) VALUES ($iid, '$idate', '$itotal', '$ipdfurl', $iaid, $idid, '$idname', '$idattn', '$idaddress', '$idaddress2', '$idinvoiceemail', 0)");

// mysqli_query returns false if something went wrong with the query
if($result2 === FALSE) { echo 'died at line 602 insert invoices query result2 which means there is no iid defined henceforth';
...
?>
<button id="myBtn" style="display:none">Preview Invoice</button>
...
<div id="myModal" class="modal" style="width:100%;">
  ...
  <div class="modal-content" style="width:60%;text-transform:uppercase;overflow:scroll;">
    ...
    <div style="float:right;margin-right:10em;"><button style="font-size: 1em; height:2.4em;background-color: #660000;color:#ffffff;padding:10px!important;" id="CreateInvoice" class="" >Create Invoice</button></div> 


<script type="text/javascript">
    document.getElementById("CreateInvoice").onclick = function () {
        location.href = "/admin/accnts/invoice/invoicestepthree.php";
    };
</script>
...
<div class="modal-content" style="width:70%;">
  ...
  <!--   <span class="close" id="span2">&times;</span>             
   ...
   <iframe src="../snipstuff/editdealerfrominvoicing.php?did=<?php echo $qmdid;?>" width="100%" height="700px"  sandbox="allow-forms allow-top-navigation allow-popups allow-same-origin allow-scripts allow-pointer-lock"></iframe>
...
//display: 'lightbox',
       ...
       template: '#customForm',
       fields: [ 
{"label": "Chg.Id","name":"i_charges_temp.ic_id", "type":"readonly"},
{"label": "Inv. Date","name":"i_charges_temp.ic_date", type:"datetime"},
{"label": "Inv.Id","name":"i_charges_temp.ic_iid"},

{"label": "Reg.Id","name":"i_charges_temp.ic_mid", "type":"readonly"},
...
//{label: "Rep Fee:", type: "select", name: "i_charges_temp.ic_rate", options: [ { label: "Rep Fee $150", value: 150 }, { label: "Rep Fee / Volume $125", value: 125 },{ label: "Rep Fee / Value $100", value: 100 },  { label: "Rep Fee / Prev. Arb - $0 (No Charge)", value: 0 },{ label: "Rep Fee / Prev. Arb", value: 0 }, { label: "Rep Fee / No Charge", value: 0 } ] },
//{label: "Rep Fee:", type: "select2", name: "i_charges_temp.ic_ratedesc", options: [ { label: "Rep Fee $150", value: 'Rep Fee' }, { label: "Rep Fee / Volume $125", value: 'Rep Fee / Volume' },{ label: "Rep Fee / Value $100", value:'Rep Fee / Value' },  { label: "Rep Fee / Bel Air - $100", value: 'Rep Fee / Bel Air' },{ label: "Rep Fee / Prev. Arb $0 (No Charge)", value: 'Rep Fee /Prev. Arb' }, { label: "Rep Fee / No Charge", value: 'Rep Fee / No Charge' } ] },

//{label: "Fee Description:", type: "select2", name: "i_charges_temp.ic_ratedesc", options: ["Rep Fee", "Rep Fee / Volume", "Rep Fee / Value", "Rep Fee / Bel Air","Rep Fee / Prev. Arb.","Rep Fee / No Charge" ]} ,
                ...
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                      //  '<tr class="group"><td colspan="5">'+group+'</td></tr>'
                        '<tr class="group"><td colspan="10">'+'<?php echo $dname." -- ".$daddress." -- ".$daddress2." -- ".$dinvoiceemail." -- ".$dattn." -- ".$drepfeedesc." -- ".$drepfee;?></td></tr>');
 ...
 // },
  'colvis',
    ...
    modal.style.display = "block";
     	     ...
     	     //   { id:"myBtn2",text:'Edit Dealer Address',titleAttr: '', action: function() {modal2.style.display = "block";}},
