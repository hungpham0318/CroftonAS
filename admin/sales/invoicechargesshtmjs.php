                ...
                if ( last !== group ) {
                    $(rows).eq( i ).before(
                      //  '<tr class="group"><td colspan="9">'+group+'</td></tr>'
                        '<tr class="group"><td colspan="14">'+"Invoice Number:&nbsp;"+group+'<a href="../receipts/paymenthtmljs.php?iid='+group+'&ipid=">&nbsp;&nbsp; Record payment for this invoice.</a></td></tr>'
                    );
...
/*end new data*/
 ...
 // },
  'colvis',
	/*  {
                text: 'Mark Invoice Paid in Full',
