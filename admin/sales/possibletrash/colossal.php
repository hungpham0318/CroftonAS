...
<editor-field name="master.mreqsaledate"></editor-field>
</fieldset>
           <fieldset class="hr">
...
$(document).ready(function() {
    editor = new $.fn.dataTable.Editor( {
        ajax: "colossalphp.php",
display: 'lightbox',
table: "#example",
        template: '#customForm',

       fields: [ 
{label: "mid", name:"master.mid"},
{label: "mvid", name:"master.mvid"},
{label: "maid", name:"master.maid"},
{label: "mrid", name:"master.mrid"},
{label: "muid", name:"master.muid"},
...
{label: "msalesnet", name:"master.msalesnet"},
...
{label: "mready", name:"master.mready"}
 ...
 //selector: 'td.select-checkbox'
 	...
 	titleAttr: 'Sets Sold Date to today, Status to S, and Substatus to Inv-No. Next, select record(s) and use "Edit button" to add Sold Price, Sale Type, and Sales Net',
			...
			.edit(dt.rows({selected:true}).indexes('mid'), false)
     			.val('msubstatus', 'Inv-No' )
			.val('mstatus', 'S' )
			.val('msolddate', '<?php echo date("Y-m-d");?>' )
     			.submit();},
