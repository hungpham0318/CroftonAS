...
<editor-field name="dealers.dphone"></editor-field>
                            ...
                            <fieldset class="office">
                            	...
                            	<editor-field name="dealers.dactive"></editor-field>
...
{label: "Default Fee:", type: "select", name: "dealers.drepfee",placeholderDisabled: false, options: [ "150", "125", "115","100","75", "0" ] },
...
{label: 'Active', name: 'dealers.dactive', type: "checkbox", separator: "|", options: [ {label: '', value: 1}] },
