...
<?php include "../worldview/css/snow-admin-nav.html";?>
 ...
 <div style="width:97%;margin: 0 auto;">
	//Dealers who have registered vehicles in the last ninety days.
<?php 
...
if ($testdate  <= $today) {
    /*echo'<tr style="white-space: nowrap;border:2px solid red;"><td style="border:2px solid red;">'.$row['did'].'</td>'.'<td style="border:2px solid red;">'.$row['dname'].'</td>'.'<td style="border:2px solid red;">'.$row['dcity'].'</td>'.'<td style="border:2px solid red;">'.$row['dsdphone'].'</td>'.'<td style="border:2px solid red;">'.$row['dcontact'].'</td>'.'<td style="border:2px solid red;">'.$row['dnumber'].'</td>'.'<td style="border:2px solid red;">'.$row['mdid'].'</td>'.'<td style="border:2px solid red;">'
  .date("m-d-y", strtotime($row['mrtime'])).'</td>'.'</tr>';*/
    }else{ echo'<tr style="border:2px solid green;"><td style="border:2px solid green;">'.$row['did'].'</td>'.'<td style="border:2px solid green;">'.$row['dname'].'</td>'.'<td style="border:2px solid green;">'.$row['dcity'].'</td>'.'<td style="border:2px solid green;">'.$row['dsdphone'].'</td>'.'<td style="border:2px solid green;">'.$row['dcontact'].'</td>'.'<td style="border:2px solid green;">'.$row['dnumber'].'</td>'.'<td style="border:2px solid green;">'.date("m-d-y", strtotime($row['mrtime'])).'</td>'.'</tr>';}}
