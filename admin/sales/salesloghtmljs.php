...
{label: "Rep Fee", name:"master.mrepfee", type:"select", options: [
{ label: '$150.00', value: '150' },    
{ label: ' $125.00', value: '125' },
{ label: '$115.00', value: '115' },
...
{label: 'Rep Fee / Promo', value: 'Rep Fee / Promo' },
  ...
  header: true,
   ...
   orientation: 'landscape',
    ...
    customize: function (doc) {
        ...
        //str.toUpperCase()
   //  doc.content[0].text = doc.content[0].toUpperCase();
        // Create a footer
        doc['footer']=(function(page, pages) {
            return {
                columns: [
