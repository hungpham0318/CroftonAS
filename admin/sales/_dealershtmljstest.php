...
<div id="udr" style="border:1px solid #660000;width:45%;display:inline-block;margin:30px;float:left;"></div><div id="whatever">Baise cette merde!</div>
 <div id="customForm">
whatever<div id="whatever">Baise cette merde!</div>
...
{"label": "Invoices to: (Comma Separated)","name":"dealers.dinvoiceemail"},
...
//$('td', row).attr('title','The information in Auction, Registrant, and Dealership columns is only editable when using the checkbox selector and the Edit button.');
  ...
  //if ( data.master.msubstatus =='Inv-No' ){ 
   ...
   //}
          ...
          var ud1 = '<iframe src="/admin/sales/dcrelatejointest.html?did=';
var ud2 = 0;
var ud3 = '" width="100%" height="500px"  sandbox="allow-same-origin allow-modals allow-scripts"></iframe>';
   var qdid = 0;
 var qdidurl ='<a href="/admin/sales/dcrelatejointest.html?did=';
        var qdidurl2 ='">id</a>';
$('#example tbody').on( 'click', 'tr', function () {
        $(this).toggleClass('selected');
        ud2 = table.row( this ).id().substr(-4);
        qdid = table.row( this ).id().substr(-4);
