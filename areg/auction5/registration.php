...
<head>
	...
	<link rel="shortcut icon" href="http://www.croftonas.com/images/favicon.ico" sizes="256x256">
...
<td><input id="dname" name="dname" tabindex="1">
   ...
   <tr>
        ...
        <tr>
            ...
            <td><input id="txtPrice1" class="txtPrice" type="text" pattern="^[+-]?[0-9]{1,9}(?:\.[0-9]{1,2})?$"autofocus required title="Please remove the comma if present!" name="txtPrice1" value="" maxlength="7" > <span class="errorFeedback errorSpan" id="txtPrice1Error"></span></td>
        </tr>
        <tr>
