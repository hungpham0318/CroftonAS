...
.ui-icon, .ui-widget-content .ui-icon {
    background-image: url(https://www.croftonas.com/areg/css/images/ui-icons_ffffff_256x240.png);
...
<!--<option value="auction/registration.php">Manheim Pennsylvania</option>
	...
	<div id="mydatepicker"><label>Requested Sale Date</label></br><p><input type="text" class="inputbox" name="sale_date" id="datepicker" placeholder="Click here to Request Sale Date" required readonly /></p></div></br></br>
...
<!--	<button type="submit" style = "margin-left: 35%!important;" class="btn btn-primary" id="submit-button">Continue</button>-->

The registration process is unavailable at this time, please check back later to register vehicles.  If you prefer, email the vehicle registration information to suzanne@croftonas.com and you will receive confirmation of when your registration is completed.  We apologize for any inconvenience.
        </form>
