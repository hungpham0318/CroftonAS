...
<!--<option value="auction/registration.php">Manheim Pennsylvania</option>
	...
	<div id="mydatepicker" class = "datepicker"><label>Requested Sale Date</label></br><p><input type="text" class="datepicker" name="sale_date" id="datepicker" placeholder="Click here to Request Sale Date" required /></p></div></br></br>
