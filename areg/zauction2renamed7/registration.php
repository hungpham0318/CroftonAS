...
<head>
	...
	<link rel="shortcut icon" href="http://www.croftonauctionservices.com/favicon.ico" sizes="256x256">
	...
	<form id="registration" name="registration" method="POST" action="process/form-process-reg.php">
        ...
        <div id="formtitle">
            <div id="hline4"><br></div>
            	Crofton Auction Services - Demonstration &nbsp;&nbsp;</div> <!-- end formtitle div -->
    <div id="userdealer">
	<table id="dealeruser">
       <colgroup>
    ...
    <table id="emailmessage">
       ...
       <col span="1" style="width: 86%;">
    	...
    	<tr>
            ...
            <td><textarea rows="3" name="inpemailtextarea" form="registration" id="inpemailtextarea" placeholder="This is a demonstration only.  No cars will be registered for auction using this form. If you wish to register vehicles use the back arrow on your browser and choose an auction. When using the actual registration form, additional information you provide in this area is delivered automatically to the auction with registration. After successful registration you will be provided with the option to include other information only to Crofton Auction Services." title="This is a demonstration only.  No cars will be registered for auction using this form. If you wish to register vehicles use the back arrow on your browser and choose an auction. When using the actual registration form, additional information you provide in this area is delivered automatically to the auction with registration. After successful registration you will be provided with the option to include other information only to Crofton Auction Services."></textarea></td>
        </tr>
   ...
   <tr>
        ...
        <tr>
            ...
            <td><select id="popDetail1" class="popDetail 1" name="popDetail1" title="Full or Partial(Wash & Wipe)">
                     <option id="full1" value="Full">Full ($150)</option>
                    <option id="partial1" value="Partial">Partial ($50)</span></option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail2" class="popDetail 2" name="popDetail2" title="Full or Partial(Wash & Wipe)">
                    <option id="full2" value="Full">Full ($150)</option>
                    <option id="partial2" value="Partial">Partial ($50)</option>
                </select></td>
		...
		<tr>
			...
			<td><select id="popDetail3" class="popDetail 3" name="popDetail3" title="Full or Partial(Wash & Wipe)">
					<option id="full3" value="Full">Full ($150)</option>
					<option id="partial3" value="Partial">Partial ($50)</option>
				</select></td>
		...
		<tr>
            ...
            <td><select id="popDetail4" class="popDetail 4" name="popDetail4" title="Full or Partial(Wash & Wipe)">
                    <option id="full4" value="Full">Full ($150)</option>
                    <option id="partial4" value="Partial">Partial ($50)</option>
                </select></td>
		...
		<tr>
            ...
            <td><select id="popDetail5" class="popDetail 5" name="popDetail5" title="Full or Partial(Wash & Wipe)">
                    <option id="full5" value="Full">Full ($150)</option>
                    <option id="partial5" value="Partial">Partial ($50)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail6" class="popDetail 6" name="popDetail6" title="Full or Partial(Wash & Wipe)">
                    <option id="full6" value="Full">Full ($150)</option>
                    <option id="partial6" value="Partial">Partial ($50)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail7" class="popDetail 7" name="popDetail7" title="Full or Partial(Wash & Wipe)">
                    <option id="full7" value="Full">Full ($150)</option>
                    <option id="partial7" value="Partial">Partial ($50)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail8" class="popDetail 8" name="popDetail8" title="Full or Partial(Wash & Wipe)">
                    <option id="full8" value="Full">Full ($150)</option>
                    <option id="partial8" value="Partial">Partial ($50)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail9" class="popDetail 9" name="popDetail9" title="Full or Partial(Wash & Wipe)">
                    <option id="full9" value="Full">Full ($150)</option>
                    <option id="partial9" value="Partial">Partial ($50)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail10" class="popDetail 10" name="popDetail10" title="Full or Partial(Wash & Wipe)">
                    <option id="full10" value="Full">Full ($150)</option>
                    <option id="partial10" value="Partial">Partial ($50)</option>
                </select></td>
...
elem.value = screen.availWidth;
    ...
    <tr>
		<td><input type="button" class="my-button" value="Different Auction or Date" onclick="rusureback()" /></td>
