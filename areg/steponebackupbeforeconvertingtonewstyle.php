...
<script src="//code.jquery.com/jquery-1.10.2.js"></script>
  <script src="//code.jquery.com/ui/1.11.0/jquery-ui.js"></script>
		<link rel="stylesheet" href="/areg/newsteponecss/homecss-stepone.css" type="text/css" />
		<link rel="stylesheet" href="/areg/newsteponecss/logincss-stepone.css" type="text/css" />
		
		<link rel="stylesheet" href="/areg/newsteponecss/purebuttonsstepone.css" type="text/css" />
		<link href="../images/favicon.ico" rel="shortcut icon" type="image/vnd.microsoft.icon" />
		<link rel="stylesheet" href="http://code.jquery.com/ui/1.11.0/themes/smoothness/jquery-ui.css">
		<link rel="stylesheet" href="/areg/newsteponecss/datepickerstepone.css">
...
<div id="navigation">
<a class="pure-button" href="/home.php">Home</a>
<?php if(!isset($_SESSION['username']) || $_SESSION['username']==""){}else{echo '<a class="pure-button button-success"     href="/areg/stepone.php">Register Vehicles</a>';}?>
<?php if(!isset($_SESSION['username']) || $_SESSION['username']==""){	echo '<a class="pure-button button" href="contactus.php">Contact Us</a>';}else{echo '<a class="pure-button" href="../contactcas.php">Contact CAS</a>';}?>
</div>
<div id="section1">
<div id="leftcolumns1">	
