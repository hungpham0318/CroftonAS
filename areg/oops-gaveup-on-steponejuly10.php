...
<body>
 <div class="wrapper" style="width:80%!important;max-width:display:block; margin:0 auto; padding: 1em!important;">
...
<form name="stepone" id="stepone" style="width:50%;margin:0 auto;display:block;clear:both;">
<small>All fields are are required.</small></br>
...
<!--<option value="auction/registration.php">Manheim Pennsylvania</option>
	...
	<div id="mydatepicker"><label>Requested Sale Date</label></br><p><input type="text" class="inputbox" name="sale_date" id="datepicker"  required /></p></div></br></br>
...
<input type="hidden" id="auction" name="auction" value="<?php echo $auction; ?>" class="inputbox "/>
	<button type="submit" class="btn btn-primary" id="cf_ce-submit-button">Continue</button>
        </form>
