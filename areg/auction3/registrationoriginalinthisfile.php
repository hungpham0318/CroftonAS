...
$title =  'Registration - Bel Air Auction'; 
...
<head>
	...
	<link rel="icon" type="image/png" href="http://www.croftonauctionservices.com/favicon.png">
	<link rel="shortcut icon" href="http://www.croftonauctionservices.com/images/favicon.ico" sizes="256x256">
	
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
	<link rel="stylesheet" href="css/reg.css">
	
	<script type="text/javascript" src="../common/form.js" charset="utf-8"></script> 
...
<body onkeydown="javascript:EnterKeyFilter();">
	...
	<form id="registration" name="registration" method="POST" action="process/form-process-reg.php">
        ...
        <div id="formtitle">
            <div id="hline4"><br></div>
            	Crofton Auction Services - Bel Air Auto Auction &nbsp;&nbsp;</div> <!-- end formtitle div -->
    <div id="userdealer">
	<table id="dealeruser">
       <colgroup>
   ...
   <tr>
        ...
        <tr>
            ...
            <td><select id="popDetail1" class="popDetail 1" name="popDetail1" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full1" value="Full">Full Clean($85)</option>
                    <option id="partial1" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon1" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans1" class="txtTrans 1" type="text" name="txtTrans1" value=""></td>
            <td><input id="txtPrice1" class="txtPrice" type="text" name="txtPrice1" value="" maxlength="7"> <span class="errorFeedback errorSpan" id="txtPrice1Error"></span></td>
        </tr>
        <tr>
            ...
            <td><select id="popDetail2" class="popDetail 2" name="popDetail2" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full2" value="Full">Full Clean($85)</option>
                    <option id="partial2" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon2" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans2" class="txtTrans 2" type="text" name="txtTrans2" value=""></td>
            <td><input id="txtPrice2" class="txtPrice" type="text" name="txtPrice2" value="" maxlength="7"> <span class="errorFeedback errorSpan" id="inptxtPrice2"></span></td>
		<tr>
			...
			<td><select id="popDetail3" class="popDetail 3" name="popDetail3" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full3" value="Full">Full Clean($85)</option>
                    <option id="partial3" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon3" value="NoRecon">No Recon($0)</option>
                
                </select></td>
			<td><input id="" class="txtTrans 3" type="text" name="txtTrans3" value=""></td>
			<td><input id="txtPrice3" class="txtPrice 3" type="text" name="txtPrice3" value="" maxlength="7"> 
		...
		<tr>
            ...
            <td><select id="popDetail4" class="popDetail 4" name="popDetail4" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full4" value="Full">Full Clean($85)</option>
                    <option id="partial4" value="Partial">Wash & Vac($35)</option>
                    <option id="norecon4" value="NoRecon">No Recon($0)</option>
                
                </select></td>
                

            <td><input id="txtTrans4" class="txtTrans 4" type="text" name="txtTrans4" value=""></td>
            <td><input id="txtPrice4" class="txtPrice 4" type="text" name="txtPrice4" value="" maxlength="7"> 
		...
		<tr>
           ...
           <td><select id="popDetail5" class="popDetail 5" name="popDetail5" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full5" value="Full">Full Clean($85)</option>
                    <option id="partial5" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon5" value="NoRecon">No Recon($0)</option>
                
                </select></td>            <td><input id="txtTrans5" class="txtTrans 5" type="text" name="txtTrans5" value=""></td>
        ...
        <tr>
            ...
            <td><select id="popDetail6" class="popDetail 6" name="popDetail6" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full6" value="Full">Full Clean($85)</option>
                    <option id="partial6" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon6" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans6" class="txtTrans 6" type="text" name="txtTrans6" value=""></td>
            <td><input id="txtPrice6" class="txtPrice 6" type="text" name="txtPrice6" value="" maxlength="7">
       ...
       <td><select id="popDetail7" class="popDetail 7" name="popDetail7" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full7" value="Full">Full Clean($85)</option>
                    <option id="partial7" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon7" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans7" class="txtTrans 7" type="text" name="txtTrans7" value=""></td>
            <td><input id="txtPrice7" class="txtPrice 7" type="text" name="txtPrice7" value="" maxlength="7"> 
        ...
        <tr>
            ...
            <td><select id="popDetail8" class="popDetail 8" name="popDetail8" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full8" value="Full">Full Clean($85)</option>
                    <option id="partial8" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon8" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans8" class="txtTrans 8" type="text" name="txtTrans8" value=""></td>
            <td><input id="txtPrice8" class="txtPrice 8" type="text" name="txtPrice8" value="" maxlength="7"> 
        ...
        <tr>
            ...
            <td><select id="popDetail9" class="popDetail 9" name="popDetail9" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full9" value="Full">Full Clean($85)</option>
                    <option id="partial9" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon9" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans9" class="txtTrans 10" type="text" name="txtTrans9" value=""></td>
            <td><input id="txtPrice9" class="txtPrice 9" type="text" name="txtPrice9" value="" maxlength="7"> 
        ...
        <tr>
            ...
            <td><select id="popDetail10" class="popDetail 10" name="popDetail10" title="Full Clean($85) -- Wash&Vac($35) -- NoRecon($0)">
                    <option id="full10" value="Full">Full Clean($85)</option>
                    <option id="partial10" value="WashVac">Wash & Vac($35)</option>
                    <option id="norecon10" value="NoRecon">No Recon($0)</option>
                
                </select></td>
            <td><input id="txtTrans10" class="txtTrans 10" type="text" name="txtTrans10" value=""></td>
            <td><input id="txtPrice10" class="txtPrice 10" type="text" name="txtPrice10" value="" maxlength="7"> 
...
elem.value = screen.availWidth;
    ...
    <tr>
		<td><input type="button" class="my-button" value="Repick Auction/Date" onclick="rusureback()" /></td>
     		...
     		<td><input type="submit"  class="my-button success" value="Submit Form" name="submit"></td>
			</tr>
