...
mysqli_select_db($con2, crofton_cas) or die("Could not connect to Database: line 171: ".mysqli_error());
	$masterEntry = array();
	$masterTbl=array(); 
	//grab the content
	$j=1;
...
$subject = "Registration: ".strip_tags($_POST['dname'])." BEL AIR";
...
$headers .= 'Bcc: belair@croftonas.com' . "\r\n";
...
$subject = "Reg-".strip_tags($_POST['dname'])." BEL AIR";
