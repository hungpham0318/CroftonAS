	...
	<form id="registration" name="registration" method="POST" action="process/form-process-reg.php">
        ...
        <div id="formtitle">
            <div id="hline4"><br></div>
            	Crofton Auction Services - TestPage &nbsp;&nbsp;</div> <!-- end formtitle div -->
    <div id="userdealer">
	<table id="dealeruser">
       <colgroup>
    ...
    <table id="emailmessage">
       ...
       <col span="1" style="width: 86%;">
    	...
    	<tr>
            ...
            <td><textarea rows="3" name="inpemailtextarea" form="registration" id="inpemailtextarea" placeholder=""></textarea></td>
        </tr>
