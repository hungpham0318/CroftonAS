...
//begin mastersnippet for master table
...
mysqli_select_db($con2, croftona_cas) or die("Could not connect to Database: line 135: ".mysqli_error());
	$masterEntry = array();
	$masterTbl=array(); 
	//grab the content
	$j=1;
