...
$msauction = mysqli_real_escape_string($con,'LANCASTER PA');
$maid = mysqli_real_escape_string($con,2);
...
//echo "line66";  
$rid='null';
 $stmt = $con->prepare("INSERT INTO `r_record_temp` (`r_id`,`r_uid`, `r_did`, `dname`, `inpFiveMilNum`, `inpYourEmail`, `inpSaleDate`, `SaleDate`,`inpYourName`, `inpSDContact`, `inpDPhone`, `inpYourPhone`, `auction`, `rtime`,`inpemailtextarea`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
//echo "Successfully Recorded r_record....line 74  <br>";
	$stmt = $con->prepare("SELECT r_id FROM r_record_temp WHERE rtime = '$rtime'");
	$result = $stmt->execute();
...
$to = "suzanne@croftonas.com, miked@croftonas.com";
$subject = "Registration: ".strip_tags($_POST['dname'])." LANCASTER PA";
...
//$to = "3017067951@txt.att.net";

$to = "testreg@croftonas.com";
$subj = "Reg-".strip_tags($_POST['dname'])." LANCASTER PA";
//$subj = "Reg-".strip_tags($_POST['dname'])." LANCASTER PA";
$hdrs = "From:crofton@croftonas.com \r\n";
$hdrs .= "Content-Transfer-Encoding: 7bit" . "\r\n";
//$mssge = "SaleDate:" . strip_tags($_POST['inpSaleDate']). "\r\n";
//$mssge = "Reg-".strip_tags($_POST['dname'])." LANCASTER PA \r\n";
...
echo '<td class="non"><h3>Auction Location: LANCASTER PA</h3></td></tr></table>';
