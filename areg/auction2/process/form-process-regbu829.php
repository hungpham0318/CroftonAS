...
$msauction = mysqli_real_escape_string($con,strtoupper($mauction));
...
echo '<h3><a href="http://www.croftonas.com/contactcas.php?msg=1"><span style="color:black;background-color:white;">Finished</span></h3></a></td>';
