   ...
   <tr>
        ...
        <tr>
            ...
            <td><select id="popDetail1" class="popDetail 1" name="popDetail1" title="Full or Partial(Wash & Wipe)">
                     <option id="full1" value="Full">Full ($175)</option>
                    <option id="partial1" value="Partial">Partial ($60)</span></option>
                </select></td>
            <td><input id="txtTrans1" class="txtTrans 1" type="text" name="txtTrans1" value=""></td>
            <td><input id="txtPrice1" class="txtPrice" type="text" name="txtPrice1" class="txtPrice" type="text" pattern="^[+-]?[0-9]{1,9}(?:\.[0-9]{1,2})?$" autofocus required title="Remove commas if present" value="" maxlength="7"> <span class="errorFeedback errorSpan" id="txtPrice1Error"></span></td>
        </tr>
        <tr>
            ...
            <td><select id="popDetail2" class="popDetail 2" name="popDetail2" title="Full or Partial(Wash & Wipe)">
                    <option id="full2" value="Full">Full ($175)</option>
                    <option id="partial2" value="Partial">Partial ($60)</option>
                </select></td>
		...
		<tr>
			...
			<td><select id="popDetail3" class="popDetail 3" name="popDetail3" title="Full or Partial(Wash & Wipe)">
					<option id="full3" value="Full">Full ($175)</option>
					<option id="partial3" value="Partial">Partial ($60)</option>
				</select></td>
		...
		<tr>
            ...
            <td><select id="popDetail4" class="popDetail 4" name="popDetail4" title="Full or Partial(Wash & Wipe)">
                    <option id="full4" value="Full">Full ($175)</option>
                    <option id="partial4" value="Partial">Partial ($60)</option>
                </select></td>
		...
		<tr>
            ...
            <td><select id="popDetail5" class="popDetail 5" name="popDetail5" title="Full or Partial(Wash & Wipe)">
                    <option id="full5" value="Full">Full ($175)</option>
                    <option id="partial5" value="Partial">Partial ($60)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail6" class="popDetail 6" name="popDetail6" title="Full or Partial(Wash & Wipe)">
                    <option id="full6" value="Full">Full ($175)</option>
                    <option id="partial6" value="Partial">Partial ($60)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail7" class="popDetail 7" name="popDetail7" title="Full or Partial(Wash & Wipe)">
                    <option id="full7" value="Full">Full ($175)</option>
                    <option id="partial7" value="Partial">Partial ($60)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail8" class="popDetail 8" name="popDetail8" title="Full or Partial(Wash & Wipe)">
                    <option id="full8" value="Full">Full ($175)</option>
                    <option id="partial8" value="Partial">Partial ($60)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail9" class="popDetail 9" name="popDetail9" title="Full or Partial(Wash & Wipe)">
                    <option id="full9" value="Full">Full ($175)</option>
                    <option id="partial9" value="Partial">Partial ($60)</option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail10" class="popDetail 10" name="popDetail10" title="Full or Partial(Wash & Wipe)">
                    <option id="full10" value="Full">Full ($175)</option>
                    <option id="partial10" value="Partial">Partial ($60)</option>
                </select></td>
