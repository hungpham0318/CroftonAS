...
include '../../common/msqcon.php';	
$conn=mysqli_connect("$dbhost","$dbuser","$dbpass","$dbname")or die("Could not connect to MySQL: ".mysqli_error());
...
$zdid = $_POST['did'];
include '../../common/msqcon.php';	
$conz= mysqli_connect("$dbhost","$dbuser","$dbpass","$dbname")or die("Could not connect to MySQL: ".mysqli_error());
...
include '../../common/msqcon.php';	
$con2= mysqli_connect("$dbhost","$dbuser","$dbpass","$dbname")or die("Could not connect to MySQL: ".mysqli_error());
