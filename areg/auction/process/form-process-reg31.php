...
//$dbname = "crofton_cas";
include '../../common/msqcon.php';	
$conn=mysqli_connect ($dbhost,$dbname, $dbuser, $dbpass)or die("Could not connect to MySQL: ".mysqli_error());
mysqli_select_db($conn) or die("Could not connect to Database line 92:".mysqli_error());
	$vehEntry = array();
	$vehTbl=array(); 
	//grab the content
	$j=1;
...
$zdid = $_POST['did'];
include '../../common/msqcon.php';	
$conz=mysqli_connect ($dbhost,$dbname, $dbuser, $dbpass)or die("Could not connect to MySQL: ".mysqli_error());

mysqli_select_db($conz) or die("Could not connect to Database: line 152: ".mysqli_error());
//mysqli_select_db($conz, crofton_cas) or die("Could not connect to Database: line 153: ".mysqli_error());
//echo $zdid;
...
include '../../common/msqcon.php';	
$con2=mysqli_connect ($dbhost,$dbname, $dbuser, $dbpass)or die("Could not connect to MySQL: ".mysqli_error());
//mysqli_select_db($con2, crofton_cas) or die("Could not connect to Database: line 165: ".mysqli_error());

mysqli_select_db($con2) or die("Could not connect to Database: line 167: ".mysqli_error());
	$masterEntry = array();
	$masterTbl=array(); 
	//grab the content
	$j=1;
...
$headers .= 'Cc: distinctivedetail@dejazzd.com,eshelmandave804@gmail.com,'. strip_tags($_POST['inpYourEmail']) .  "\r\n";
$headers .= 'Bcc: missyo@croftonas.com,kellyz@croftonas.com,crofton@comcast.net,distinctivemanheim@gmail.com'.  "\r\n";
