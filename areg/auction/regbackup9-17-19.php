...
<body style="background-image: url(/images/wideaerial-sm3.jpg);" onkeydown="javascript:EnterKeyFilter();">
   ...
   <tr>
        ...
        <tr>
            ...
            <td><input id="txtPrice1" class="txtPrice" type="text" name="txtPrice1" class="txtPrice" type="text"  value="" maxlength="7"> <span class="errorFeedback errorSpan" id="txtPrice1Error"></span></td>
        </tr>
        <tr>
