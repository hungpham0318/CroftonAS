...
<head>
  ...
  <script src="//code.jquery.com/ui/1.11.0/jquery-ui.js"></script>
		...
		<link rel="stylesheet" href="../common/css/css/datepicker.css">
...
<div id="navigation">
		...
		<?php if(!isset($_SESSION['uusername']) || $_SESSION['uusername']==""){	echo '<a class="pure-button button-success" href="../contactus.php">Contact Us</a>';}else{echo '<a class="pure-button" href="../contactus.php">Contact CAS</a>';}?>
       </div>
		<div id="section1">
<div id="leftcolumns1">
