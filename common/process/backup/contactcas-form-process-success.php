<?php session_start();
    ...
    function getRealIp() {
       ...
       return $ip;
    	...
    	$date2 = date("D M j G:i:s T Y");
			...
			$message .= '<tr><td><strong>Auction:</strong> </td><td>' . strip_tags($_POST['auction']) . "</td></tr>";
			$message .= "</table>";
			$message .= "</body></html>";
	...
	$subject = 'Follow-up to '. $_POST['auction'];
            ...
            function Redirect($url, $permanent = false)
{
    ...
    exit();
            ...
            {Redirect('http://croftonauctionservices.com/common/mailsuccesscontactus-user.php', false);
