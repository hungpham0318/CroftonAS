...
<form name="contactcas" id="contactcas" class="contactusfrm" method="post" action="">
...
<td><label>Name:</label></td><td><input type="text" name="uname" id="uname" value="<?php echo $uname; ?>"  required>
	...
	<button type="text" style="margin:0 auto; margin-top:40px;display:block;width:30px;" class="btn btn-primary" >Send</button>
</fieldset><br>
        </form>
