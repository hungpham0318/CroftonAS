...
<body style="background-image: url(/images/wideaerial-sm3.jpg);" onkeydown="javascript:EnterKeyFilter();"> -->
	...
	<table id="dealeruser">
       ...
       <col span="1" style="width: 36%;">
        ...
        <tr>
                    <th></th>
                    <td><input id="inpFiveMilNum" type="hidden" name="inpFiveMilNum" value="<?php echo $dnumber;?>" maxlength="10" placeholder="<?php echo $dnumber;?>" tabindex="2">
                    </td>
                    <th></th>
        ...
        <tr>
            ...
            <th></th>
            <td><input id="inpYourEmail" style="hidden-transform: lowercase;" type="hidden" name="inpYourEmail" value="suzanne@croftonas.com" maxlength="100" placeholder="" tabindex="10">
    ...
    <table id="emailmessage">
       ...
       <col span="1" style="width: 89%;float:left;">
    	</colgroup>
    <tr>
            <th>Registration Message:</th>
            <td><textarea rows="3" name="inpemailtextarea" form="registration" id="inpemailtextarea" placeholder="Additional information you provide in this area is included in this email to the auction."></textarea></td>
        </tr>
   ...
   <tr>
        ...
        <tr>
           ...
           <td><select id="popDetail1" class="popDetail 1" name="popDetail1" title="">
                    <option  value="Wash&Vac">Wash&Vac ($25)</option>
                    <option  value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail2" class="popDetail 2" name="popDetail2" title="Wash&Vac or Detail">
                     <option  value="WashVac">Wash&Vac ($25)</option>
                    <option  value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail9" class="popDetail 9" name="popDetail9" title="Wash&Vac or Detail">
