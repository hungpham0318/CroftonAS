...
foreach($masterTbl as $masterEntry){ $insertm=mysqli_query($con2, "INSERT INTO `priority_master`(`mid`,`mvid`,`mrid`,`muid`,`mdid`,`maid`,`mvin`,`myear`,`mmake`,`mmodel`,`mcolor`,`mmileage`,`mannounce`,`mstock`,`mdetail`,`mtransport`,`mfloor`,`mrtime`) VALUES ('', '{$masterEntry[11]}', '$arrmrid','$msuid','$msdid','$maid','{$masterEntry[0]}','{$masterEntry[1]}', '{$masterEntry[2]}','{$masterEntry[3]}','{$masterEntry[4]}', '{$masterEntry[5]}','{$masterEntry[6]}','{$masterEntry[7]}','{$masterEntry[8]}','{$masterEntry[9]}','{$masterEntry[10]}', '$arrmrtime')") ;}	
