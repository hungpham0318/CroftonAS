...
//$headers .= 'Cc: russell.stevens@adesa.com,elizabeth.mendoza@adesa.com,'. strip_tags($_POST['inpYourEmail']) .  "\r\n";
//$headers .= 'Cc: russell.stevens@adesa.com,elizabeth.mendoza@adesa.com'. "\r\n";
