...
<body style="" onkeydown="javascript:EnterKeyFilter();">
    <!--
<body style="background-image: url(/images/wideaerial-sm3.jpg);" onkeydown="javascript:EnterKeyFilter();"> -->
       ...
       <col span="1" style="width: 36%;">
    	...
    	<tr>
         ...
         <!-- <td><input id="inpSaleDate" type="text" name="inpSaleDate"   pattern="\d{4}[\-]\d{2}[\-]\d{2}"  value="<?php echo $_POST['sale_date']; ?>" maxlength="10" required placeholder="" tabindex="6"> -->
            <td><input id="inpSaleDate" type="hidden" name="inpSaleDate"  value="<?php echo $_POST['sale_date']; ?>" maxlength="10" readonly placeholder="" tabindex="6" >
        ...
        <tr>
                    ...
                    <th></th>
                    <td><input id="inpYourName" type="hidden" name="inpYourName" value="<?php echo  $_POST['uname']; ?>" maxlength="50" placeholder="" tabindex="7">
        ...
        <tr>
            ...
            <th></th>
            <td><input id="inpYourPhone" pattern="\d{3}[\-]\d{3}[\-]\d{4}" type="hidden" title="xxx-xxx-xxxx" name="inpYourPhone" value="<?php echo $_POST['umobile']; ?>" maxlength="20" placeholder="" required tabindex="8">
			<span class="errorFeedback errorSpan" id="inpYourPhoneError"></span>
			</td>
		</tr>
        <tr>
            <th></th>
            <td><input id="inpDPhone" type="hidden" name="inpDPhone" value="" maxlength="20" placeholder="" tabindex="4">
			<span class="errorFeedback errorSpan" id="inpDPhoneError"></span></td>
            <th></th>
            <td><input id="inpYourEmail" style="hidden-transform: lowercase;" type="hidden" name="inpYourEmail" value="<?php echo  $_POST['uemail']; ?>" maxlength="100" placeholder="" tabindex="10">
    ...
    <table id="emailmessage">
       ...
       <col span="1" style="width: 86%;">
    	...
    	<tr>
            <th></th>
            <td><input type="hidden" name="inpemailtextarea" form=""></td>
        </tr>
   ...
   <tr>
        ...
        <tr>
           ...
           <td><select id="popDetail1" class="popDetail 1" name="popDetail1" title="Wash&Vac or Detail">
                     <option id="full1" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial1" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail2" class="popDetail 2" name="popDetail2" title="Wash&Vac or Detail">
                     <option id="full2" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial2" value="Detail">Detail ($75)</span></option>
                </select></td>
		...
		<tr>
			...
			<td><select id="popDetail3" class="popDetail 3" name="popDetail3" title="Wash&Vac or Detail">
                     <option id="full3" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial3" value="Detail">Detail ($75)</span></option>
                </select></td>
		...
		<tr>
           ...
           <td><select id="popDetail4" class="popDetail 4" name="popDetail4" title="Wash&Vac or Detail">
                     <option id="full4" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial4" value="Detail">Detail ($75)</span></option>
                </select></td>
		...
		<tr>
           ...
           <td><select id="popDetail5" class="popDetail 5" name="popDetail5" title="Wash&Vac or Detail">
                     <option id="full5" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial5" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
            ...
            <td><select id="popDetail6" class="popDetail 6" name="popDetail6" title="Wash&Vac or Detail">
                     <option id="full6" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial6" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail7" class="popDetail 7" name="popDetail7" title="Wash&Vac or Detail">
                     <option id="full7" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial7" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail8" class="popDetail 8" name="popDetail8" title="Wash&Vac or Detail">
                     <option id="full8" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial8" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
           ...
           <td><select id="popDetail9" class="popDetail 9" name="popDetail1" title="Wash&Vac or Detail">
                     <option id="full9" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial9" value="Detail">Detail ($75)</span></option>
                </select></td>
        ...
        <tr>
         ...
         <td><select id="popDetail10" class="popDetail 10" name="popDetail10" title="Wash&Vac or Detail">
                     <option id="full10" value="Wash&Vac">Wash&Vac ($25)</option>
                    <option id="partial10" value="Detail">Detail ($75)</span></option>
                </select></td>
                </select></td>
...
elem.value = screen.availWidth;
	...
	<script type="text/javascript" src="/priority/adesa/process/form.js" charset="utf-8"></script> 
