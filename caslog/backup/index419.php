...
$nuid="null";
		...
		try {
			...
			$stmt = $db->prepare('INSERT INTO users(username,password,email,active,uname,umobile,uaddress,ucity,ustate,uzip,ufax,uofficeph,ucompany,unotes,ucas,uperms) VALUES (:username, :password,:email, :active,:uname, :umobile, :uaddress, :ucity, :ustate, :uzip, :ufax, :uofficeph, :ucompany, :unotes, :ucas, :uperms)');
			$stmt->execute(array(
...
<input type="hidden" name="uaddress" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['uaddress']); } ?>" tabindex="6" ></td>





<input type="hidden" name="ucity" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['ucity']); } ?>" tabindex="7"  >
<input type="hidden" name="ustate"  value="<?php if(isset($error)){ echo strip_tags($_POST['ustate']); } ?>" tabindex="8" ></td>

<input type="hidden" name="uzip" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['uzip']); } ?>" tabindex="9" >
