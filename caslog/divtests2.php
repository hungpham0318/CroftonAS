...
<p>Click the "Try it" button to change the font-family property of the DIV element:</p>

<button onclick="myFunction()">Arial 1em</button>
...
<span class="first">
<div id="myDIV"><p>Begin Div 1<p> <button onclick="myReplace()">Replace-1st-Div</button></p>
...
</div><div id="flipback">Click to hide</div>
...
elmyDIV.innerHTML = 'HEY! WHAT HAPPENED? inner html let my button through</br>'+inmyDIV;
}
