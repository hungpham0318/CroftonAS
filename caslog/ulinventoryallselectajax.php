...
$result = mysqli_query($conn,"SELECT DISTINCT dealers.did, dealers.dname FROM master, dealers WHERE master.muid = $q AND master.mdid = dealers.did AND marchive=0 AND dealers.dactive != 0 ORDER BY dname ASC");
//$result = mysqli_query($conn,"SELECT DISTINCT dealers.did, dealers.dname FROM ud_relate, dealers WHERE ud_relate.u_id = $q AND ud_relate.d_id = dealers.did AND marchive=0");
