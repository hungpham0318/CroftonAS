...
<div style="width:100%;margin:0 auto;">
				...
				<h2 style="width:60%;margin-top:2%;margin-left:40%;margin-bottom:2%;" > Welcome <?php echo $_SESSION['uname']; ?></br>My Registrations for last 90 days</h2></br>  
				<form action="ulinventory.php" method="POST">
<div id="myDIV2"><p>
<?php
echo $gottendname;
$gottendid='';
...
if (mysqli_connect_errno($conn))
 ...
 $result = mysqli_query($conn,"SELECT did, dname FROM dealers WHERE did = $gottendid ORDER BY dname ASC");
 ...
 while($row = mysqli_fetch_array($result))    {$gottendname= $row['dname'];
    ...
    echo '<option value="" selected="selected" ><span style="color:darkblue;">'.$gottendname."</span></option>";
		...
		echo'<option value="">CHOOSE DEALERSHIP</option>';
			...
			include_once 'ulinventoryselectajax.php';
...
<div style="margin-left: 30%"><a href="ulinventoryall.php">View ALL Registrations for My Dealerships for Last 90 Days</a></div>
