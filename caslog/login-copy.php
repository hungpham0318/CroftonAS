...
<form class="clasfrm2"style="max-width:30%;display:block;margin:auto; border:1px solid #ccc; " role="form" method="post" id="login" action="" autocomplete="off">
<h2>Welcome</h2>
<hr>
<?php
...
<input type="hidden" type="password" name="fakepasswordremembered"  >
