	...
	<div class="row">
	    ...
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				<h2><p><span style="font-weight:600;font-size: 1.2em;line-height: 1.2em;">Reset Password</span><br><span style=";line-height: 1.2em;font-weight:500;font-size: 1.1em;">
				Enter your email address and we will send you a link in your email to reset your password. It must be the same as the email used to create your account.</p></span></h2><br>
