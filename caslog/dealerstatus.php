...
echo "Happy Monday Morning, Mike and Mike!<br>";
...
//$addresses = "miked@croftonas.com, mikec@croftonas.com, suzanne@croftonas.com";
			//send email
$to = "suzianne@aol.com";
