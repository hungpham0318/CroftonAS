...
<tr>
<td><label>*Company: </label></td><td><input type="text" name="ucompany" value="<?php if(isset($error)){ echo strip_tags($_POST['ucompany']); } ?>" tabindex="4" required></td>
</tr>

<tr>
<td><label>Auction Access No.:</label></td><td><input type="text" class="sup-input" title="AA number for Your Company." name="aanumber" placeholder="(For your company)" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['aanumber']); } ?>" tabindex="5"></td>
</tr>

<tr>
<td><label>Address:</label></td><td><input type="text" name="uaddress" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['uaddress']); } ?>" tabindex="6" ></td>
</tr>



<tr>
<td><label>City:</label></td><td><input type="text" name="ucity" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['ucity']); } ?>" tabindex="7"  ></td>
</tr>
<tr>
<td><label>State:</label></td><td><input type="text" name="ustate"  value="<?php if(isset($error)){ echo strip_tags($_POST['ustate']); } ?>" tabindex="8" ></td>

</tr>

<tr>
<td><label>Zip:</label></td><td><input type="text" name="uzip" maxlength="250" value="<?php if(isset($error)){ echo strip_tags($_POST['uzip']); } ?>" tabindex="9" ></td>
</tr>
<tr>
