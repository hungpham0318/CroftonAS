...
<form class="clasfrm2"style="" role="form" method="post" id="login" action="" autocomplete="off">
...
<input style="display:none" type="password" name="fakepasswordremembered"/></br></br>

<input id="username" style="margin:0 auto; width:300px;" type="text" placeholder="Username"  name="username" autofocus  value="<?php if(isset($error)){ echo $_POST["username"];}?>">   
    	</br></br>
...
<div class="forgpwd">
    	...
    	<fieldset id="actions">
        <input type="submit"  id="submit" value="Login" name="submit"  class="btn btn-primary" tabindex="5">
       </fieldset>
   </fieldset></br></br></br>   
		...
		<!-- <h2><div style="width:80%; margin: auto;">
