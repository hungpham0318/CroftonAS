...
<div class="container-supform">	
			<form role="form" class="sup-form" method="post" action="" autocomplete="off">
				...
				if(isset($_GET['action']) && $_GET['action'] == 'joined'){
					echo "<h2 class='bg-success'>Registration successful! Watch your email for your registration confirmation.(If you don't receive an email within (x) hours, please ... (Finish this)</h2>";
				}
				?>
...
<td class="sup-label">&nbsp;</td><td><input type="password" name="passwordConfirm" id="passwordConfirm" class="sup-input" placeholder="Confirm Password" tabindex="15"></td>
 ...
 <tr>
 <td class="sup-label">&nbsp;</td><td><input type="hidden" name="uperms" id="uperms" class="sup-input" placeholder="uperms" value="1"></td> 
