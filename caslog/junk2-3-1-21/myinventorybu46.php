...
<style>
td.child{text-transform:Uppercase;}
td.sorting-1{padding-top:1px!important;
...
echo '<div id="table-scroll" style="width:99%!important;font-family:Roboto Mono, monospace!important;font-size: .86em;"><table id="example" class="display responsive nowrap" cellspacing="0" >';
$quid=$GLOBALS['quid'];
...
<th>Floor</th>
	...
	echo '<tr><td>'.date("m/d", strtotime($row['mrtime'])).'</td>
...
$('td', row).css('padding-right','1px');
//$('td', row).css('font-family','monospace');
//$('td', row).css('white-space','nowrap');
$('td', row).css('font-size','1.2em');
$('td', row).css('padding-bottom','8px');

$('td', row).css('padding-top','8px');
$('td', row).css('line-height','16px');
$('td', row).css('text-transform', 'Uppercase');}
