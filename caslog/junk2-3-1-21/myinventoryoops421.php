...
echo '<div id="table-scroll" style="width:99%!important;font-family:Roboto Mono, monospace!important;font-size: .86em;">

<p id="table-filter-select" style="display:none">
Dealership: 
<select>
<option value="">need to include a php script</option>
<option>To populate</option>
<option>These options</option>
<option>With Dealerships</option>
<option>in this current</option>
<option>Mercedes Benz of Arlington</option>
<option>Lindsay Lexus</option>
...
echo '<thead><tr style="width:99%!important;font-family:Roboto Mono, monospace!important;font-size: .7em;">
<th>Submitted</th>
<th>Dealer</th>
<th>Vin</th>
<th>Status</th>
...
echo '<tfoot><tr style="width:99%!important;font-family:Roboto Mono, monospace!important;font-size: .7em;">
<th>Submitted</th>
<th>Dealer</th>
<th>Vin</th>
<th>Status</th>
...
<th>Floor</th>
	...
	echo '<tr><td>'.date("m/d/Y", strtotime($row['mrtime'])).'</td>
	<td>'.$row['dname'].'</td>
	<td>'.$row['mvin'].'</td>
	<td>'.$row['mstatus'].'</td>
	<td>'.$row['msolddate'].'</td>
...
dom: 'rf<"table-filter-container">tip',
       initComplete: function(settings){
          var api = new $.fn.dataTable.Api( settings );
 $('.table-filter-container', api.table().container()).append(
             $('#table-filter-select').detach().show()
          );
          $('.table-filter-container', api.table().container()).append(
             $('#table-filter-select').detach().show()
          );
          
          $('#table-filter-select select').on('change', function(){
