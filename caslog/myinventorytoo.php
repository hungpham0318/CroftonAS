...
//	 $query2 = mysqli_query($con,"SELECT * FROM master LEFT JOIN i_charges ON  (master.mid=i_charges.ic_mid) LEFT JOIN invoices ON (master.minvid = invoices.iid)  LEFT JOIN dealers ON (master.mdid = dealers.did) WHERE master.muid = $quid AND master.marchive = 0 LIMIT 0, 10000");
//	 $query2 = mysqli_query($con,"SELECT * FROM master LEFT JOIN i_charges ON  (master.mid=i_charges.ic_mid) LEFT JOIN invoices ON (master.minvid = invoices.iid)  LEFT JOIN dealers ON (master.mdid = dealers.did) LEFT JOIN ud_relate ON (master.mdid = ud_relate.d_id) LEFT JOIN ud_relate ON (master.muid = ud_relate.u_id) WHERE ud_relate.d_id = master.mdid AND master.marchive = 0 LIMIT 0, 10000");
//   $query2 = mysqli_query($con,"SELECT * FROM master LEFT JOIN i_charges ON  (master.mid=i_charges.ic_mid) LEFT JOIN invoices ON (master.minvid = invoices.iid)  LEFT JOIN dealers ON (master.mdid = dealers.did) WHERE master.marchive = 0 LIMIT 0, 10000");
   $query2 = mysqli_query($con,"SELECT * FROM master LEFT JOIN i_charges ON  (master.mid=i_charges.ic_mid) LEFT JOIN invoices ON (master.minvid = invoices.iid)  LEFT JOIN dealers ON (master.mdid = dealers.did) LEFT JOIN ud_relate ON (ud_relate.d_id = master.mdid) LEFT JOIN ud_relate ON (ud_relate.u_id = master.muid)WHERE master.mdid = ud_relate.d_id master.marchive = 0 LIMIT 0, 10000");
//	 $query2 = mysqli_query($con,"SELECT * FROM master LEFT JOIN i_charges ON  (master.mid=i_charges.ic_mid) LEFT JOIN invoices ON (master.minvid = invoices.iid)  LEFT JOIN dealers ON (master.mdid = dealers.did) WHERE master.mdid = $qmdid AND master.marchive = 0 LIMIT 0, 10000");
