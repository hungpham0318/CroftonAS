...
<div style="width:100%;margin:0 auto;">
				...
				<h2 style="width:60%;margin-top:2%;margin-left:30%;margin-bottom:2%;" > ALL Registrations for My Dealerships for Last 90 days</h2></br>  
				<form action="ulinventoryall.php" method="POST">
<div id="myDIV2"><p>
<?php
echo $gottendname;
$gottendid='';
 ...
 while($row = mysqli_fetch_array($result))    {$gottendname= $row['dname'];
    ...
    echo '<option value="" selected="selected" ><span style="color:darkblue;">'.$gottendname."</span></option>";
		...
		echo'<option value="">CHOOSE DEALERSHIP</option>';
			...
			include_once 'ulinventoryallselectajax.php';
...
?>
			...
			<!--	<h2>Member only page - Welcome</br>-->
				...
				echo $dealer;
				include 'ulinventorysnipall.html';
				echo $row['dname'];
				?>
				</h2>
...
<div style="margin-left: 30%"><a href="ulinventory.php">View only My registrations for last 90 days</a></div>
