...
<div id="navigation">
	<?php include"../caslog/includes/navcontents.html";?>
	 </div> 
...
<div style="width:100%;margin:0 auto;">
			...
			<!--	<h2 style="width:60%;margin-top:20%;margin-left:40%;margin-bottom:60%;" > Reports for <?php echo $_SESSION['uname']; ?></h2> -->
			...
			<a href="ulinventory.php">My Inventory</a></br>
			<!--	<a href="ulinventoryall.php">Complete Inventory For My Dealerships</a> -->
...
<div>	<?php echo 'Complete Inventory For My Dealerships:<br><div style="font-size:13px; font-weight: normal; font-family: "Open Sans";">';
...
$result = mysqli_query($con,"SELECT * FROM ud_relate, dealers WHERE u_id = $quid AND d_id = did");
 ...
 while($row = mysqli_fetch_array($result))
    {
     echo '<a href="ulinventoryall.php?did='.$row['did'].'">'.$row["dname"].'</a></br>';
	 }?></div>
