...
<div style="width:100%;margin:0 auto;">
				...
				<!--<h2 style="width:60%;margin-top:2%;margin-left:40%;margin-bottom:2%;" > Welcome <?php echo $_SESSION['uname']; ?></br>Your Registrations for last 180 days</h2></br>  -->
		...
		*/		
		?>		
			...
			<!--	<h2>Member only page - Welcome</br>-->
				...
				echo $dealer;
				include 'ulinventorysnipsingle.html';
				echo $row['dname'];
				?>
				</h2>
