       ...
       <script src="https://www.google.com/recaptcha/api.js" async defer></script>
		...
		<div style="clear:both;"></div>
            ...
            if (isset($_SESSION['notification'])) {
                ...
                <p style="text-align: justify; text-transform: none;">Your message has been sent. Messages are usually replied to in 24-48 hours.<br/> Please add the following email address to your contacts to ensure you can receive our emails:</p>
                <p style="font-weight:bold;">'.$_SESSION['messageemail'].'</p>
                <h4 style="text-align: center;">THANK YOU!</h4>
                <button type="sumbit" id="close-message" class="submit-button btn-group btn btn-primary" onclick="closeMsg()">Ok</button>';
                
            } else {
            echo '
             		<form method="post" id="newMessage"  action="/template/newcontact_message2.php" >
                    ...
                    <button type="submit" class="btn btn-primary" style="float:right;" name="submit" value="submit">
                        Send 
                    </button>
            ...
            <div id="ohboy" class="form-popup contact-area" style="display: none;">
                <h3>Thank you!</h3>
                <p>Your message has been sent. Messages are usually responded to in 24-48 hours.<br/> Please add the following email address to your contacts to ensure you can receive our emails:</p>
                <p style="font-weight:bold;"><?php echo $_SESSION['messageemailadd'];?></p>
                <h4 style="text-align: center;">THANK YOU!</h4>
...
$(document).ready(function(){
	...
	$("#newMessage").submit(function(e){
		...
		$.ajax({
			url: "/template/newcontact_message2.php",
			type: "POST",
			data: form_data
		}).done(function(data){		    
			//$("#thankyou").html(data);
