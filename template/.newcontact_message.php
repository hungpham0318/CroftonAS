...
$cascontactip  = filter_var($contactip, FILTER_SANITIZE_STRING);
...
//$to      = 'miked@croftonas.com, suzannenbird@gmail.com';
...
$message .='<h3 style="font-weight: bold;">'.$cascontactip.'</h3>';
