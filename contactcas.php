...
<div id="navigation">
<?php require "./caslog/includes/navcontents.html"; ?><br><br>
<?php if($msg <= '0'){echo'';}else{echo 'Thank you.  Your registration was successfully submitted.  You can use this form to send <br>follow-up information only to CAS, not the auction. This message will also be sent to your email address for your records. <br><br>';}?>
</div>
...
<tr><td><div>
	<input id="" type="submit" class="btn btn-primary" style="height:2em;" name="submit" value="Send Message"></div>
	</td></tr>
</tbody></table>
        </form>
